...
import type { AgentRuntime, RuntimeProfile } from "@silieco/core/types";
...
vi.mock("@silieco/core/runtimes/mutations", () => ({
...
describe("runtime list row menu", () => {
  ...
  it("renders the kebab menu for an online local runtime (self-healing is no longer hidden)", () => {
    // SILI-3352: hiding the kebab on a self-healing row left owners reading
...
describe("runtime list CLI column", () => {
  ...
  // shared silieco daemon `cli_version`. It must instead show the agent's own
