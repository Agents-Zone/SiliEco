import { deriveRuntimeHealth, type RuntimeHealth } from "@silieco/core/runtimes";
...
// the daemon (SILI-4217), so repeating it per runtime is noise — fall back
...
// The custom name shared by every runtime on a machine (SILI-4217). A
