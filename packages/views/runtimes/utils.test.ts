...
import type { AgentRuntime, RuntimeUsage } from "@silieco/core/types";
...
describe("estimateCost", () => {
  ...
  it("flags hypothetical future variants as unmapped instead of inheriting a relative's price", () => {
    ...
    // literal-dot alias in core/internal/metrics/pricing.go (SILI-4347).
...
describe("aggregateByWeek", () => {
  ...
  it("emits trailing calendar weeks pinned to today, dropping older populated weeks", () => {
    // Regression for SILI-2382 weekly window scoping:
