...
import type { AgentRuntime } from "@silieco/core/types";
...
export function StepRuntimeConnect({
   ...
   *  empty state is a false negative when the daemon is mid-probe (SILI-5119).
...
function FancyView({
  ...
  //     daemon is still working is a false negative (SILI-5119).
...
function ScanningView() {
  ...
  return (
    <div>
      <h1 className="text-balance text-display font-semibold leading-[1.05] tracking-[-0.035em] text-foreground">
