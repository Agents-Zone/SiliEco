...
import { runtimeDisplayLabel } from "@silieco/core/runtimes";
...
function CliWaitingStatus({ dialogOpen }: { dialogOpen: boolean }) {
  ...
  // Stage thresholds are rough — `silieco setup` typical flow is
      ...
      >
        {stage === "normal" && (
          <>
            ...
            <span className="font-mono">{"silieco setup"}</span>
