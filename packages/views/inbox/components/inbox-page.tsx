...
import {
  ...
  useInboxUnreadCount,
} from "@silieco/core/inbox/queries";
import {
  useMarkInboxRead,
  useArchiveInbox,
  useUnarchiveInbox,
...
} from "@silieco/core/inbox/mutations";
...
import type { InboxItem } from "@silieco/core/types";
...
import { NumberFlow } from "@silieco/ui/components/ui/number-flow";
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
  ...
  const detailContent = selected?.issue_id ? (
    ...
    <ErrorBoundary resetKeys={[selected.issue_id]}>
      <IssueDetail
        ...
        layoutId="silieco_inbox_issue_detail_layout"
