...
vi.mock("@silieco/core/i18n/react", async () => {
  const actual =
    await vi.importActual<typeof import("@silieco/core/i18n/react")>(
      "@silieco/core/i18n/react",
    );
  return {
    ...actual,
    useLocaleAdapter: () => ({
...
import { useCommentComposerStore } from "@silieco/core/issues/stores";
...
describe("PreferencesTab — Timezone section", () => {
  ...
  // slow CI runners (SILI-4427). Everything these tests pick — Asia/Tokyo
