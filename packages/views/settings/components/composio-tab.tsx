...
import type { ComposioToolkit } from "@silieco/core/types";
...
//
// Key UX rule (SILI-4009): the backend only returns toolkits with an enabled
...
export function ComposioTab() {
  ...
  // Service.CallbackRedirect, SILI-3720). Consume it exactly once: fire a toast,
  ...
  // (SILI-3719) lands, but the branch is wired up now so it lights up for free.
  ...
  // stamping it (Stage 3, SILI-3721); the card shows a "never used" placeholder
  // until then.
