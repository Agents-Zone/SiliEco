...
import type { PersonalAccessToken } from "@silieco/core/types";
import { Alert, AlertDescription } from "@silieco/ui/components/ui/alert";
...
export function TokensTab() {
  ...
  const handleCopyCommand = async () => {
    if (!newToken) return;
    if (await copyText(`silieco login --token ${newToken}`)) {
