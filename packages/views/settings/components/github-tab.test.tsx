...
vi.mock("@silieco/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@silieco/core/github")>("@silieco/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/Silieco will stop receiving webhooks/i)).toBeTruthy();
