...
import { RESOURCE_LABELS_FLAG } from "@silieco/core/feature-flags";
...
import {
  ...
  useDeleteLabel,
  useUpdateLabel,
} from "@silieco/core/labels";
import type { Label, LabelResourceType } from "@silieco/core/types";
...
import { Label as FieldLabel } from "@silieco/ui/components/ui/label";
import {
  Dialog,
  DialogContent,
  DialogDescription,
