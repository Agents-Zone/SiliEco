...
import { slackInstallationsOptions, slackKeys } from "@silieco/core/slack";
import { api } from "@silieco/core/api";
import type { SlackInstallation } from "@silieco/core/types";
...
// path is per-agent (each Silieco agent gets exactly one bot — the
  ...
  const prefix = lang?.startsWith("zh")
    ...
    : lang?.startsWith("ja")
      ...
      : lang?.startsWith("ko")
        ? "/ko"
        : "";
  return `https://silieco.ai/docs${prefix}/slack-bot-integration`;
}
