...
import { memberListOptions, workspaceKeys } from "@silieco/core/workspace/queries";
import {
  deriveGitHubSettings,
  githubInstallationsOptions,
} from "@silieco/core/github";
...
export function GitHubTab() {
  ...
  // sees it after SILI-2413); `canManage` gates the Connect / Disconnect
              ...
              description={
                <p className="text-body text-muted-foreground">
                  ...
                  <code className="rounded bg-muted px-1 py-0.5 text-caption">
                    {"Co-authored-by: silieco-agent <github@silieco.ai>"}
                  </code>{" "}
