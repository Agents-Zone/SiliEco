...
import type { Skill } from "@silieco/core/types";
...
vi.mock("@silieco/core/permissions", () => ({
  useSkillPermissions: () => ({ canEdit: { allowed: true, reason: null } }),
}));
vi.mock("@silieco/core/workspace/avatar-url", () => ({
...
vi.mock("@silieco/ui/components/common/capability-banner", () => ({
