...
import type { CommentTriggerPreviewAgent, CommentTriggerOutcome } from "@silieco/core/types";
import { useAgentPresenceDetail } from "@silieco/core/agents";
import { mentionLabelsByTarget } from "@silieco/core/issues/comment-trigger-outcomes";
...
import { AVATAR_SIZE_PX } from "@silieco/ui/lib/avatar-size";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@silieco/ui/components/ui/popover";
import { Tooltip, TooltipContent, TooltipTrigger } from "@silieco/ui/components/ui/tooltip";
...
interface CommentTriggerChipsProps {
  ...
  // (SILI-4525 §2). Each renders as a named warning chip so the user sees WHICH
