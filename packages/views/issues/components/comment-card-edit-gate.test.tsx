...
import type { Attachment, TimelineEntry } from "@silieco/core/types";
import type { UploadResult } from "@silieco/core/hooks/use-file-upload";
import { useCommentDraftStore } from "@silieco/core/issues/stores";
...
vi.mock("@silieco/core/api", () => ({
  // Uploads flow through the coordinator, which calls api.uploadFile (SILI-5181).
...
// SILI-4808 — comment edit had no upload gate: saving mid-upload persisted the
