...
import type { WorkspaceWorkingAgent } from "@silieco/core/types";
...
vi.mock("@silieco/ui/components/ui/button", async () => {
  const actual =
    await vi.importActual<typeof import("@silieco/ui/components/ui/button")>(
      "@silieco/ui/components/ui/button",
    );
  return {
    ...actual,
