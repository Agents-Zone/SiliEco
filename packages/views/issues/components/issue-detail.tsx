...
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from "@silieco/ui/components/ui/resizable";
import { Sheet, SheetContent } from "@silieco/ui/components/ui/sheet";
import { useIsMobile } from "@silieco/ui/hooks/use-mobile";
...
import { FileUploadButton } from "@silieco/ui/components/common/file-upload-button";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@silieco/ui/components/ui/tooltip";
import { Popover, PopoverTrigger, PopoverContent } from "@silieco/ui/components/ui/popover";
import { Dialog, DialogContent, DialogHeader, DialogTitle } from "@silieco/ui/components/ui/dialog";
import { Checkbox } from "@silieco/ui/components/ui/checkbox";
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem } from "@silieco/ui/components/ui/command";
import { AvatarGroup, AvatarGroupCount } from "@silieco/ui/components/ui/avatar";
import { ActorAvatar } from "../../common/actor-avatar";
import { PropRow } from "../../common/prop-row";
import { PropertyIcon } from "../../common/property-icon";
import type { Attachment, Issue, IssueProperty, IssueStatus, IssuePriority, TimelineEntry, UpdateIssueRequest } from "@silieco/core/types";
import { contentReferencesAttachment } from "@silieco/core/types";
import { STATUS_CONFIG, PRIORITY_CONFIG } from "@silieco/core/issues/config";
import { formatDateOnly, isPastDateOnly } from "@silieco/core/issues/date";
import { useUpdateIssue } from "@silieco/core/issues/mutations";
...
import { WorkflowAssignmentPicker } from "../../workflows/components";
...
import { useRecentContextStore } from "@silieco/core/chat";
import { issueListOptions, issueDetailOptions, childIssuesOptions, childIssueProgressOptions, issueUsageOptions, issueAttachmentsOptions } from "@silieco/core/issues/queries";
import { projectDetailOptions } from "@silieco/core/projects/queries";
import { ProjectIcon } from "../../projects/components/project-icon";
import { issueLabelsOptions } from "@silieco/core/labels";
import { propertyListOptions } from "@silieco/core/properties";
import { memberListOptions, agentListOptions } from "@silieco/core/workspace/queries";
import {
...
} from "@silieco/core/issues/stores";
import { useIssueSelectionStore } from "@silieco/core/issues/stores/selection-store";
import { BatchActionToolbar } from "./batch-action-toolbar";
import { useIssueTimeline } from "../hooks/use-issue-timeline";
import { useIssueReactions } from "../hooks/use-issue-reactions";
import { useIssueSubscribers } from "../hooks/use-issue-subscribers";
import { ReactionBar } from "@silieco/ui/components/common/reaction-bar";
...
export function IssueDetail({ issueId, onDelete, onDone, defaultSidebarOpen = true, layoutId = "silieco_issue_detail_layout", highlightCommentId }: IssueDetailProps) {
  const { t } = useT("issues");
  ...
  // Pull-based scroll restoration (SILI-4741): the platform serves the offset
    ...
    <div className="space-y-5">
      ...
      <div>
        ...
        {propertiesOpen && <div className="grid grid-cols-[auto_1fr] gap-x-2 gap-y-0.5 pl-2">
          ...
          {issue.project_id && (
            <PropRow label="SOP / Stage">
              <div className="flex min-w-0 flex-wrap gap-1">
                <WorkflowAssignmentPicker
                  projectId={issue.project_id}
                  workflowInstanceId={issue.workflow_instance_id ?? undefined}
                  workflowStageId={issue.workflow_stage_id ?? undefined}
                  onChange={(assignment) =>
                    handleUpdateField({
                      workflow_instance_id:
                        assignment.workflowInstanceId ?? null,
                      workflow_stage_id: assignment.workflowStageId ?? null,
                    })
                  }
                />
              </div>
  ...
  const detailContent = (
    <div className="relative flex h-full min-w-0 flex-1 flex-col">
        {/* In-page find bar — floats over the top-right of the content column
            ...
            its close button (SILI-4414). On desktop it also steps inside the
        ...
        {/* scrollbar-gutter both-edges: with classic (space-taking) scrollbars —
            ...
            centered column reads 32px left vs 43px right (SILI-4404). Mirroring
          ...
          <div {...descDropZoneProps} className="relative mt-5 rounded-lg">
            <ContentEditor
              ...
              onUpdate={(md) => {
                ...
                // bind via `contentReferencesAttachment` (SILI-3130 / SILI-3192).
              ...
              // the image markdown and its attachment_ids bind (SILI-3254).
        ...
        {/* Thread quick-jump rail — rides the scroll container's right edge,
            ...
            scrolling (SILI-4522). right-3 is the inset that works in both
