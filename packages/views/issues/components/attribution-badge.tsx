...
/**
 * AttributionBadge renders who an agent run is accountable to (SILI-4302 §9):
 ...
 * the raw `source` field (SILI-4768).
 *
 * Three shapes, all silent when no responsible member resolved (SILI-4765):
...
export function AttributionBadge({
  ...
  // (SILI-4768). The cautionary tone therefore fires for any non-precise source
