...
import type { Issue, UpdateIssueRequest } from "@silieco/core/types";
import { commonIssueFields } from "@silieco/core/issues/batch";
import { useBatchUpdateIssues, useBatchDeleteIssues } from "@silieco/core/issues/mutations";
...
export function BatchActionToolbar({
  ...
  // Batch status changes apply directly — no run-confirm modal (SILI-4155).
  ...
  // without an extra confirmation step (product decision on SILI-4155). The
