 ...
 *
 * SILI-4985 regression — cold-load render loop on the Issues route.
 *
...
import type { Issue } from "@silieco/core/types";
...
vi.mock("@silieco/core/issues/mutations", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@silieco/core/issues/mutations")>();
  return {
    ...actual,
...
vi.mock("@silieco/core/issues/stores/view-store-context", () => ({
...
describe("Issues cold-load render loop (SILI-4985)", () => {
  beforeEach(() => {
    vi.clearAllMocks();
