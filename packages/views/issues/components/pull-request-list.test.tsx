...
import type { GitHubPullRequest } from "@silieco/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@silieco/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@silieco/core/github/queries")>(
    "@silieco/core/github/queries",
  );
  return {
    ...actual,
