...
// Mock @silieco/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@silieco/core/issues/stores/view-store", () => ({
...
vi.mock("@silieco/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@silieco/core/issues/stores/selection-store", () => ({
...
vi.mock("@silieco/core/issues/stores/recent-issues-store", () => ({
