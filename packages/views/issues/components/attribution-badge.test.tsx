...
import type { TaskAttribution } from "@silieco/core/types";
...
describe("AttributionBadge", () => {
  ...
  it("shows a backfilled attribution in the normal tone, not a warning (SILI-4768)", () => {
  ...
  it("avatar variant shows no warning ring for a backfilled attribution (SILI-4768)", () => {
    const attribution: TaskAttribution = {
      source: "backfill",
      precise: false,
      initiator: { id: "u5", name: "Bohan" },
  ...
  it("renders nothing when no responsible member resolved (SILI-4765)", () => {
    const attribution: TaskAttribution = {
      source: "unattributed",
      precise: false,
    };
