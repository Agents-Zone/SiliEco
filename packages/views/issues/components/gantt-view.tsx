...
import type { GanttZoom } from "@silieco/core/issues/stores/view-store";
import { projectListOptions } from "@silieco/core/projects/queries";
import type { Issue, IssueStatus } from "@silieco/core/types";
import { dateOnlyToUTCDate } from "@silieco/core/issues/date";
...
// viewer's timezone. See @silieco/core/issues/date.
...
export function GanttView({ issues }: { issues: Issue[] }) {
  ...
  // rows this canvas would never draw (SILI-4884). Keep this view a renderer:
