...
import { STATUS_CONFIG } from "@silieco/core/issues/config";
import { useViewStoreApi } from "@silieco/core/issues/stores/view-store-context";
...
// `EmptyPlaceholder`/`Footer` throws (SILI-4474).
...
export const BoardColumn = memo(function BoardColumn({
  ...
  // Pull-based scroll restoration (SILI-4741): assign the saved offset at
    ...
    <div style={{ width: BOARD_COL_WIDTH }} className={`flex shrink-0 flex-col rounded-xl ${cfg?.columnBg ?? "bg-muted/40"} p-2`}>
      ...
      <div className="relative min-h-[200px] flex-1 rounded-lg">
        ...
        <div
          ...
          // (SILI-4741): the group id is the stable memento key, so every
