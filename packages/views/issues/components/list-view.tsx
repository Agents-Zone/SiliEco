...
import type { Issue, IssueStatus, Project } from "@silieco/core/types";
...
// restored scrollTop assignment stick at ref-attach (SILI-4741).
...
function ListViewImpl({
  ...
  // Pull-based scroll restoration (SILI-4741): assign the saved offset when
...
function StatusAccordionItem({
  ...
  const listComponents = useMemo(
    () => ({
      ...
      // is ever undefined (SILI-4474). The footer itself renders null for a
  ...
  // measurement frame keeps those rows instead of flashing empty (SILI-4750).
