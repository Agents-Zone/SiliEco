...
import type { SwimlaneGrouping } from "@silieco/core/issues/stores/view-store";
...
import { useLoadMoreByStatus } from "@silieco/core/issues/mutations";
import { childrenByParentsOptions, issueKeys, type IssueSortParam, type MyIssuesFilter } from "@silieco/core/issues/queries";
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
...
import { ALL_STATUSES, STATUS_CONFIG } from "@silieco/core/issues/config";
...
function SwimLaneViewImpl({
  ...
  // Pull-based scroll restoration (SILI-4741): same wiring as board/list/
      ...
      <div ref={attachScroller} data-tab-scroll-root="swimlane" className="flex flex-1 min-h-0 gap-4 overflow-auto p-4">
        ...
        >
          {/* Seed a bounded slice of real lanes while the scroll ref hasn't
              ...
              survive the measurement frame (SILI-4750). */}
          {scrollEl ? (
            <Virtuoso
