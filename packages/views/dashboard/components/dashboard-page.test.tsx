...
vi.mock("@silieco/core/runtimes/custom-pricing-store", () => {
...
describe("DashboardPage — viewing timezone drives the query key", () => {
  ...
  // (see dashboardKeys in @silieco/core/dashboard/queries).
...
// SILI-5409. The server folds every agent it won't name — those the viewer may
...
describe("DashboardPage — leaderboard density", () => {
  ...
  it("ranks the top 10 agents and keeps the tail behind a toggle", async () => {
    ...
    // card a full screen below the fold (SILI-5388).
