/**
 * Cross-surface sanitize contract (SILI-4922).
 *
 ...
 * canonical base from @silieco/ui/markdown.
 *
...
// still differ. Converging them is the RichCodeBlock phase of SILI-4922; until
