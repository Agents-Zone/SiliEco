...
import type { AgentRuntime, AgentTask } from "@silieco/core/types/agent";
import { useTranscriptViewStore } from "@silieco/core/agents/stores";
...
vi.mock("@silieco/ui/lib/clipboard", () => ({
...
vi.mock("@silieco/ui/components/ui/dropdown-menu", async () => {
...
vi.mock("@silieco/ui/components/ui/collapsible", async () => {
  const React = await import("react");
