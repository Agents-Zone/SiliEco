...
import { clearWorkspaceStorage, defaultStorage } from "@silieco/core/platform";
import { resetAllRegisteredDrafts } from "@silieco/core/drafts/cleanup-registry";
...
export function useLogout() {
  ...
  return useCallback(() => {
    ...
    defaultStorage.removeItem("silieco_tabs");
