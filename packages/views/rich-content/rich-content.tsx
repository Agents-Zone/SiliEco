...
/**
 * RichContent — the ONE product-level readonly content renderer (SILI-4922).
 *
...
import { useWorkspacePaths, useWorkspaceSlug } from "@silieco/core/paths";
...
/**
 * Autolinked bare identifier (e.g. `SILI-123`) routed through
...
export const RichContent = memo(function RichContent({
  ...
  // code block (SILI-3621). A stable element reference lets React bail out.
