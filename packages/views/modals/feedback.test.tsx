...
vi.mock("@silieco/core/paths", () => ({ useCurrentWorkspace: () => ({ id: "ws1" }) }));
vi.mock("@silieco/core/hooks/use-file-upload", () => ({
  useFileUpload: () => ({ uploadWithToast: vi.fn() }),
}));
vi.mock("@silieco/core/api", () => ({ api: {} }));
vi.mock("sonner", () => ({ toast: { info: vi.fn(), error: vi.fn(), success: vi.fn() } }));
vi.mock("@silieco/core/feedback", () => ({
...
describe("FeedbackModal", () => {
  ...
  // SILI-4808 — Feedback refused to submit mid-upload inside the handler, but
