...
// `api.uploadFile(file, ctx, signal)` (SILI-5181 L2).
...
vi.mock("@silieco/ui/components/common/file-upload-button", () => ({
  ...
  // guarantee is actually assertable here (SILI-4808).
...
describe("AgentCreatePanel", () => {
  ...
  // SILI-5181 P0: success may only consume the draft it submitted — the editor
  ...
  // SILI-5181 P0: a submit that outlives its dialog may only consume the draft
  ...
  // SILI-4808 — Quick Create already gated Create; these pin the two gaps:
  ...
  // SILI-4931 — this path files a real issue, so a double-fire is a duplicate
