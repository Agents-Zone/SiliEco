...
/**
 * Issue-create binding for the coordinated-upload engine (SILI-5181, L2).
 *
...
import { useIssueDraftStore } from "@silieco/core/issues/stores";
import type { CreateMode } from "@silieco/core/issues/stores";
