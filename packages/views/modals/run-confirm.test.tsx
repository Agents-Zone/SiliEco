...
vi.mock("@silieco/core/hooks", () => ({ useWorkspaceId: () => "ws-test" }));
...
vi.mock("@silieco/ui/components/ui/textarea", () => ({
  Textarea: (props: React.TextareaHTMLAttributes<HTMLTextAreaElement>) => <textarea {...props} />,
}));
vi.mock("@silieco/ui/components/ui/spinner", () => ({
...
describe("RunConfirmModal", () => {
  it("is fully operable on the first frame — no preview request, no spinner", () => {
    // The SILI-5010 core: opening the dialog fires nothing and blocks nothing.
