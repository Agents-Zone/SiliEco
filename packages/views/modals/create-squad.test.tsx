...
import type { Agent, MemberWithUser, Squad } from "@silieco/core/types";
...
vi.mock("@silieco/ui/components/ui/input", () => ({
  Input: (props: React.InputHTMLAttributes<HTMLInputElement>) => (
    <input {...props} />
  ),
}));

vi.mock("@silieco/ui/components/ui/label", () => ({
