...
import type { RuntimeModelThinkingLevel } from "@silieco/core/types";
...
/**
 * Per-agent reasoning/effort picker (SILI-2339). Renders only when the
 ...
 * the user's local CLI install, not by Silieco's catalog.
 */
      ...
      {levels.map((l) => (
        ...
        >
          ...
          {/* No model-factory-default badge here on purpose: when the
              picker is "Follow CLI config" (value === ""), Silieco omits
