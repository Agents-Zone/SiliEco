...
import type { RuntimeModel } from "@silieco/core/types";
import { runtimeModelsOptions } from "@silieco/core/runtimes";
...
function pickModelEntry(
  ...
  // Mirrors the backend ValidateThinkingLevel. (SILI-4347)
