...
import type { Agent, MemberWithUser, RuntimeDevice } from "@silieco/core/types";
...
describe("CreateAgentDialog access picker (SILI-4010, feature-flag gated)", () => {
  beforeEach(() => {
    vi.clearAllMocks();
