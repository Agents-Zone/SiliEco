...
import { useAgentPermissions } from "@silieco/core/permissions";
import { Button } from "@silieco/ui/components/ui/button";
import { CapabilityBanner } from "@silieco/ui/components/common/capability-banner";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function AgentDetailPage({ agentId }: AgentDetailPageProps) {
  ...
  // Chat shares the invocation gate with assignment (SILI-3963): starting a
