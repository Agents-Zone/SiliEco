...
//
// Covers the canonical taxonomy in core/pkg/taskfailure — 7 platform-side
// reasons plus 14 `agent_error.*` sub-reasons — and the pre-SILI-1949 coarse
...
// since SILI-1949: a task that failed on a provider 401 rendered no reason
// at all.
const REASON_LABEL: Record<string, string> = {
  ...
  // Pre-SILI-1949 coarse values, still present on historical rows.
