...
import { useNavigationStore } from "@silieco/core/navigation";
...
import { workspaceListOptions } from "@silieco/core/workspace";
import { useRecentIssuesStore } from "@silieco/core/issues/stores";
