...
import { issueIdentifierOptions } from "@silieco/core/issues/queries";
import { workspaceListOptions } from "@silieco/core/workspace/queries";
import { isIssueIdentifier } from "@silieco/ui/markdown";
...
interface ContentEditorBaseProps {
   ...
   * Silieco editors still render as the normal pill. Use for editors where
...
interface ContentEditorRef {
   ...
   * path (SILI-5181): an upload that outlived the mount that started it settles
...
const ContentEditor = forwardRef<ContentEditorRef, ContentEditorProps>(
  function ContentEditor(
    ...
    // API host (SILI-3192, Desktop/Electron).
