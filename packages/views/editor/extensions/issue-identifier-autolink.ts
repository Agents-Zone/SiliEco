 ...
 * identifiers (e.g. `SILI-123`) in the editable editor.
 *
 ...
 * the canonical `[SILI-123](mention://issue/<uuid>)`.
 *
...
export interface ResolvedIssueRef {
  /** Issue UUID. */
  id: string;
  /** Canonical identifier as returned by the server, e.g. "SILI-123". */
  identifier: string;
}
...
// detector in @silieco/ui/markdown.
