...
// ---------------------------------------------------------------------------
// Escape containment (SILI-5429): Escape while a picker is open must close ONLY
...
// ---------------------------------------------------------------------------
// isPickerAcceptKey — the shared accept-key policy (SILI-3685)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Plugin-order guard (SILI-3685): when a suggestion is open inside a list item,
...
// in item 2 for Tab -> sinkListItem to actually fire (Howard, SILI-3685 review):
