 ...
 * (post-SILI-3130) persist the stable `/api/attachments/<id>/download`
 ...
 * triggered SILI-3130. The id-from-URL extractor handles new content;
  ...
  const value = useMemo<ResolvedDownload>(
    () => {
      const lookup = (url: string): Attachment | undefined => {
        ...
        // before SILI-3130, S3/CloudFront markdown that points
