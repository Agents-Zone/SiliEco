 ...
 *      in core/internal/handler/file.go so the proxy endpoint accepts it.
...
// core/internal/handler/file.go. If an extension lands here but the proxy
...
// (mirror reserved-slugs pattern in core/internal/handler/reserved_slugs.json).
