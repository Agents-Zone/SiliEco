...
describe("AttachmentPreviewModal — dispatch", () => {
  ...
  it("renders an iframe with srcdoc + sandbox='allow-scripts' for HTML", async () => {
    ...
    await waitFor(() => {
      ...
      // (SILI-2330). The combination with `allow-same-origin` would defeat
...
describe("AttachmentPreviewModal — server-relative download_url resolution (SILI-2976)", () => {
...
describe("AttachmentPreviewModal — error states", () => {
  ...
  it("shows the unsupported fallback on PreviewUnsupportedError (core/client drift)", async () => {
