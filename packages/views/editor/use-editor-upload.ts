...
import { useFileUpload } from "@silieco/core/hooks/use-file-upload";
 ...
 * the caller supplies `onError` and no caller ever did (SILI-4808).
 *
 * `useFileUpload` lives in `@silieco/core`, which may not import a UI library,
