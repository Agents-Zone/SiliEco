...
import {
  ...
  DEFAULT_AVATAR_SIZE,
  type AvatarSize,
} from "@silieco/ui/lib/avatar-size";
import { parseAvatarEmoji } from "@silieco/ui/lib/avatar-emoji";
import { SiliecoIcon } from "./silieco-icon";
  ...
  return (
    ...
    >
      {emoji ? (
        ...
        <SiliecoIcon noSpin style={{ width: px * 0.55, height: px * 0.55 }} />
      ) : isAgent ? (
