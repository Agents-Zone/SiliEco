 ...
 * composer session (SILI-5181). Uploads used to live in component `useState`,
...
interface CommentDraftStore {
   ...
   * SILI-5181): an upload that finished after its composer unmounted has no
...
registerDraftCleanup({
  storageKey: "silieco_comment_drafts",
