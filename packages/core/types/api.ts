...
export interface UpdateIssueRequest {
   ...
   *  SILI-3375). The assignee/status change still applies. Control field —
   ...
   *  context (SILI-3375). Only consumed when a run actually starts. Control
...
/** Canonical Task API names. Legacy Issue names remain wire-compatible. */
export type CreateTaskRequest = CreateIssueRequest;
export type UpdateTaskRequest = UpdateIssueRequest;
export type MoveTaskRequest = MoveIssueRequest;
export type ListTasksParams = ListIssuesParams;
export type ListTasksResponse = ListIssuesResponse;
export type GroupedTasksResponse = GroupedIssuesResponse;
