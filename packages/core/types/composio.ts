 ...
 * `core/internal/handler/integrations_composio.go`. New fields the backend
...
export interface ComposioToolkit {
   ...
   * SILI-4009 the backend only returns connectable toolkits, so this is always
...
export interface ComposioConnection {
   ...
   * lands (SILI-3719), but the client renders the branch ahead of that. */
