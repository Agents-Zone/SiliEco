// Mirrors the silieco-cloud Billing module response shapes
// (silieco-cloud/docs/api/billing.md). These types are the contract our
// frontend consumes via /api/cloud-billing/* — silieco-api itself does
