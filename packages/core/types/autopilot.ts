...
// squad(id) and dispatch resolves to squad.leader_id at run time (SILI-2429,
...
// (assignee runtime offline at dispatch time, SILI-1899). The frontend MUST
...
export interface AutopilotTrigger {
  ...
  // webhook_url is only present when SILIECO_PUBLIC_URL is configured
...
export interface AutopilotRun {
  ...
  // (skipped/failed), derived server-side from failure_reason (SILI-4525). The
