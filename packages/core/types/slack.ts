/** A Slack bot installation bound to a single Silieco agent (SILI-3666).
 *
 * Wire shape mirrors `SlackInstallationResponse` in
 * `core/internal/handler/slack.go`. New fields the backend adds in the
 ...
 * the logged-in Silieco user in this workspace/installation. */
