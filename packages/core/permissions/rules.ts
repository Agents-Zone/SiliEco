 ...
 * gates in `core/internal/handler/`. Hooks in `use-resource-permissions.ts`
 ...
 * restore identically to edit (`core/internal/handler/agent.go:519-535`),
 ...
 * otherwise trigger a run. Mirrors the SILI-3963 backend invocation gate,
