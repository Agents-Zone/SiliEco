...
// Do not edit by hand — edit core/internal/handler/reserved_slugs.json
 ...
 *
 * Single source of truth: `core/internal/handler/reserved_slugs.json`.
...
export const RESERVED_SLUGS: ReadonlySet<string> = new Set([
  ...
  // `silieco` is reserved as the brand name to block impersonation workspaces.
