 ...
 *
 * Questionnaire screens are intentionally no longer part of first-run:
 *
 *   - "source" (How did you hear about Silieco?) is pure attribution
 ...
 *   - "role" / "use_case" are replaced by a one-sentence workspace
 *     description. Silieco needs the purpose of the shared workspace,
 *     not a demographic label for the person creating it.
 *
