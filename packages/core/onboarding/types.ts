export type OnboardingStep =
  | "welcome"
  /** Legacy questionnaire screen, no longer present in the step order. */
  | "about_you"
  | "runtime"
  | "workspace"
 ...
 * `OnboardingPath*` constants in `core/internal/analytics/events.go`.
 */
 ...
 * Silieco for several jobs at once); `source` and `role` are single-
