...
// Docs-local stateless Silieco mark — matches @silieco/ui's SiliecoIcon
...
// packages/ui/components/common/silieco-icon.tsx if the mark changes.
const SILIECO_CLIP = `polygon(
...
// desktop). Leading icon = brand identity (GitHub mark / Silieco asterisk);
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <span className="font-semibold text-base">Silieco Docs</span>
    ),
  },
  links: [
    {
    ...
    {
      icon: <SiliecoMark />,
      text: externalLinkText("Silieco"),
      url: "https://silieco.ai",
      external: true,
    },
  ],
};
