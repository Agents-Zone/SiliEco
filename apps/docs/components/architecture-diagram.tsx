/**
 * Silieco architecture diagram for §1.2 "How Silieco Works".
 *
 ...
 * "Silieco" (metadata store and coordinator).  The asymmetric sizes and the
 * brand-tinted left panel visually argue Silieco's core thesis: AI runs on
      ...
      <div className="flex-1 space-y-5">
        ...
        <div>
          ...
          <div className="text-xs text-muted-foreground mb-2.5">
            Polls work from Silieco. Invokes local AI coding tools:
          </div>
