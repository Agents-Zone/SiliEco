...
describe("prefixLocale", () => {
  ...
  it("leaves external URLs alone", () => {
    expect(prefixLocale("https://silieco.ai/download", "zh")).toBe(
      "https://silieco.ai/download",
    );
    expect(prefixLocale("mailto:hello@silieco.ai", "zh")).toBe(
      "mailto:hello@silieco.ai",
    );
