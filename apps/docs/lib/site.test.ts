...
describe("docsAlternates", () => {
  it("omits Korean hreflang when no Korean MDX file exists for the page", async () => {
    ...
    expect(docsAlternates(["agents"])).toEqual({
      canonical: "https://www.silieco.ai/docs/agents",
      languages: {
        en: "https://www.silieco.ai/docs/agents",
        zh: "https://www.silieco.ai/docs/zh/agents",
        "x-default": "https://www.silieco.ai/docs/agents",
      },
    });
  });
  ...
  it("includes Korean hreflang when a real *.ko.mdx page exists", async () => {
    ...
    expect(docsAlternates(["agents"])).toEqual({
      ...
      languages: {
        en: "https://www.silieco.ai/docs/agents",
        zh: "https://www.silieco.ai/docs/zh/agents",
        ko: "https://www.silieco.ai/docs/ko/agents",
        "x-default": "https://www.silieco.ai/docs/agents",
      },
    });
  });
  ...
  it("includes Japanese hreflang when a real *.ja.mdx page exists", async () => {
    ...
    expect(docsAlternates(["agents"])).toEqual({
      ...
      languages: {
        en: "https://www.silieco.ai/docs/agents",
        zh: "https://www.silieco.ai/docs/zh/agents",
        ja: "https://www.silieco.ai/docs/ja/agents",
        "x-default": "https://www.silieco.ai/docs/agents",
      },
    });
  });
  ...
  it("keeps the locale root alternates limited to real localized MDX pages", async () => {
    ...
    expect(docsAlternates([])).toEqual({
      canonical: "https://www.silieco.ai/docs",
      languages: {
        en: "https://www.silieco.ai/docs",
        zh: "https://www.silieco.ai/docs/zh",
        "x-default": "https://www.silieco.ai/docs",
      },
    });
  });
});
