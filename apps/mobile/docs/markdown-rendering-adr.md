...
not a Silieco problem.

### Concrete library survey (2026-05)

| Library | Path | Last release | Verdict for Silieco |
|---|---|---|---|
...
Silieco mobile uses a **segment-based hybrid renderer** that dispatches
...
#SILI-2397 and #SILI-2395 dark screenshots, 2026-05-19).
