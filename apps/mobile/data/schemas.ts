 ...
 * yet schematised in @silieco/core/api/schemas. Lenient by design — see the
...
import { IssueSchema } from "@silieco/core/api/schemas";
...
export const AgentSchema: z.ZodType<Agent> = z.object({
  ...
  // SILI-2600: agent resource shape no longer carries custom_env or
...
// availability derivation in @silieco/core/agents/derive-presence. All other
...
export const EMPTY_ISSUE_FALLBACK: import("@silieco/core/types").Issue = {
  id: "",
  workspace_id: "",
  number: 0,
  identifier: "",
