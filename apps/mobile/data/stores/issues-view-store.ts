 ...
 * `@silieco/core/issues/stores/issues-scope-store` — mobile only
 * `import type` from `@silieco/core/types/*` per Sharing Principles, and
...
import type { IssuePriority, IssueStatus } from "@silieco/core/types";
