...
import reactConfig from "@silieco/eslint-config/react";
...
export default [
  ...
  // Navigation boundary (SILI-4741): the tab Coordinator must be the only
  ...
  // Remaining legacy sites carry an inline eslint-disable tagged SILI-4741;
    ...
    rules: {
          ...
          paths: [
            {
              ...
              message:
                "Direct navigation from application code breaks the Coordinator protocol (SILI-4741). Use the navigation adapter from src/platform instead.",
            },
          ],
        },
      ],
      "no-restricted-syntax": [
        "error",
        {
          ...
          message:
            "Direct router.navigate from application code breaks the Coordinator protocol (SILI-4741). Route it through the navigation adapter in src/platform.",
        },
      ],
    },
  },
