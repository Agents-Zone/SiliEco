...
describe("isSafeExternalHttpUrl", () => {
  it("allows http and https URLs", () => {
    expect(isSafeExternalHttpUrl("https://silieco.ai")).toBe(true);
...
describe("openExternalSafely", () => {
  ...
  it("forwards http/https URLs to shell.openExternal", () => {
    openExternalSafely("https://silieco.ai");
    expect(shell.openExternal).toHaveBeenCalledWith("https://silieco.ai");
  });
