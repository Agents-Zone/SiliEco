...
import type { ScrollRestorationAdapter } from "@silieco/views/platform";
...
/**
 * Tab Coordinator (SILI-4741 Phase 2) — the ONLY writer of the single app
 * router.
 *
 ...
 * see ScrollRestorationProvider in @silieco/views/platform). Offsets are
