 ...
 *
 * SILI-4741 note: the old adapter also parked the tab's router at "/" when
...
/**
 * Open a path that a link inside content resolved to (the `silieco:navigate`
 ...
 *
 * SILI-4741 invariant 1: none of these operations touch the router. They
