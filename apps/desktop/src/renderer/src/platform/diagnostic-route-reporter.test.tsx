/**
 * SILI-5345 — the main window must publish which page it is showing.
 *
 * This reporting existed once and was deleted with the PostHog $pageview
 * cleanup (SILI-4127), which left the main process reading a route it was never
...
import { getDiagnosticRoute, resetDiagnosticContext } from "@silieco/core/diagnostics";
