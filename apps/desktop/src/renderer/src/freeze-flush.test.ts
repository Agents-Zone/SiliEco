/**
 * Two regressions are pinned here, both found in review of SILI-5345.
 *
 ...
 *    is precisely the SILI-4115 failure the ack protocol exists to prevent.
...
describe("telemetry props carry no raw identifiers", () => {
  ...
  it("drops workspace slug, tab id and window url if a context still carries them", () => {
    const leaky: FreezeBreadcrumb = {
      ...hang,
      context: {
        windowUrl: "file:///Users/someone/Applications/Silieco.app/index.html",
        desktopRoute: {
          surface: "tab",
          path: "/:slug/issues",
          workspaceSlug: "acme",
  ...
  // Review finding (SILI-5345): the flush side used to forward `context.stack`
        ...
        stack: [
          {
            ...
            url: "file:///Users/someone/Applications/Silieco.app/out/renderer/main.js",
