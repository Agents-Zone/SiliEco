 ...
 * "recovery" button pointing at `/Users/issues`, i.e. a second 404 (SILI-4899).
...
function useRecoveryRoute(): string | null {
  ...
  return activeWorkspaceSlug ? `/${activeWorkspaceSlug}/tasks` : null;
}
...
export function DesktopRouteErrorPage() {
  ...
  // SILI-4899: 8 of 18 desktop_route_error reports were users clicking an agent's
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <p className="max-w-lg text-body text-muted-foreground">
          Nothing in Silieco matches this address. If you got here from a link,
      ...
      <div className="flex gap-2">
        {recoveryRoute ? (
          <Button
            ...
            // the new session URL into the router (SILI-4741 invariant 1).
            onClick={() =>
              useTabStore
                .getState()
