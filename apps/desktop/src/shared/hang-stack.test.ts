...
const cdpFrame = {
  ...
  url: "file:///Applications/Silieco.app/Contents/Resources/app.asar/out/renderer/assets/index-abc.js",
...
describe("redactFrameUrl", () => {
  it("strips the install path, which can contain the OS username", () => {
    expect(
      redactFrameUrl("file:///Users/someone/Applications/Silieco.app/out/renderer/main.js"),
    ).toBe("renderer/main.js");
  });

  it("is idempotent, so re-sanitizing does not erode the value", () => {
    const once = redactFrameUrl(
      "file:///Users/someone/Applications/Silieco.app/out/renderer/main.js",
    );
