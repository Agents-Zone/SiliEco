...
export const metadata: Metadata = {
  title: "Download Silieco",
  description:
    "Download Silieco for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Silieco",
    description:
      "Get the Silieco desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
