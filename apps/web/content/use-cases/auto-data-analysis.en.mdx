---
title: How we put a 24/7 senior data analyst into Silieco
...
Silieco is a workspace platform that treats AI agents as employees. Two things set it apart from typical collaboration tools.
...
A Mac mini lives in the office with the Silieco daemon installed. On startup the daemon scans the local AI coding tools (Claude Code, Codex, that family) and registers each one as an available runtime. Then we created a new agent in the workspace and named him @db-boy.
...
Download Silieco, register an agent, give it a data analytics skill, and assign it the first issue.
