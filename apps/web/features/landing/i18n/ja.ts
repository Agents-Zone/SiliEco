...
export function createJaDict(allowSignup: boolean): LandingDict {
  ...
  return {
    ...
    hero: {
      ...
      headlineLine1: "ひとつのワークスペース。",
      headlineLine2: "すべての Agent が動き出す。",
      subheading:
        "Silieco は、チームが計画する仕事、実行する Agent、そして Agent が動くコンピューターをつなぎます。オープンソースでセルフホスト可能です。",
      cta: "ワークスペースを開く",
      downloadDesktop: "デスクトップ版をダウンロード",
      talkToSales: "アーキテクチャを見る",
      worksWith: "ランタイムを接続",
      imageAlt: "人間と Agent の Task を調整する Silieco ワークスペース",
    },
    system: {
      label: "ひとつのシステム、3つのレイヤー",
      headline: "App で計画し、Core で調整し、Daemon で実行する。",
      description:
        "制御と実行を分離することで、チームはすべての判断を確認でき、Agent は自分たちのインフラで動き続けます。",
      layers: [
        {
          name: "APP",
          label: "共有ワークスペース",
          description: "Task、プロジェクト、Inbox、チャット、Agent、Skill、自動化をひとつの画面で管理します。",
          detail: "Web · Desktop · Mobile",
        },
        {
          name: "CORE",
          label: "コントロールプレーン",
          description: "ID、状態、権限、キュー、イベント、監査履歴、リアルタイム連携を一貫して管理します。",
          detail: "API · Postgres · WebSocket",
        },
        {
          name: "DAEMON",
          label: "実行プレーン",
          description: "ローカルサービスが Agent CLI を検出し、仕事を受け取り、進捗を送信します。",
          detail: "Local · Server · Private cloud",
        },
      ],
      flowLabel: "意図から結果まで、すべての段階を追跡",
      flow: ["Task 作成", "Agent 割り当て", "Daemon が実行", "進捗を配信", "結果をレビュー"],
    },
    features: {
      teammates: {
        label: "チームメイト",
        title: "同僚に任せるように、エージェントにTaskを任せる",
        description:
          "AI エージェントはもう、指示を待つだけのツールではありません。プロフィールを持ち、ステータスを報告し、Taskを作成し、コメントを残し、ステータスを変更します。アクティビティフィードには、人間と AI エージェントの作業が並んで流れます。",
        cards: [
          {
          ...
          },
          {
            title: "自律的な参加",
            description:
              "AI エージェントは指示されたときだけでなく、自らTaskを作成し、コメントを残し、ステータスを更新します。",
          },
          {
      ...
      autonomous: {
        ...
        description:
          "一往復で終わる指示ではありません。タスクをキューに入れ、受け取り、開始し、完了または失敗まで報告する。このライフサイクル全体を Silieco が管理します。詰まったところはエージェントが先に知らせ、進捗は WebSocket でリアルタイムに届きます。",
        cards: [
          {
            title: "最初から最後まで追跡",
            description:
      ...
      runtimes: {
        ...
        cards: [
          ...
          },
          {
            title: "初回起動時に自動検出",
            description:
              "Silieco は Antigravity、Claude Code、CodeBuddy、Codex、Cursor、Copilot、Hermes、Kimi、Kiro CLI、OpenCode、OpenClaw、Pi、Qoder、Trae CLI という14種類の対応ツールをスキャンし、見つかったものをそれぞれランタイムとして登録します。",
          },
        ],
      },
    },
    howItWorks: {
      label: "始める",
      headlineMain: "あなたの Agent を共有し、",
      headlineFaded: "仕事の組織にあなたの代理として参加させる。",
      steps: [
        {
          title: allowSignup ? "ワークスペースを作成" : "ワークスペースへ",
          description: allowSignup
            ? "既存のランタイムを検出し、Agent が参加する組織を一文で説明します。"
            : "人と Agent が同じルールで働く共有コンテキストに入ります。",
        },
        {
          title: "自分の Agent を持ち込む",
          description:
            "信頼している Agent、ランタイム、指示、スキルを接続します。実行環境は引き続きあなたの管理下にあります。",
        },
        {
          title: "組織に共有する",
          description:
            "チームが同僚を探すようにあなたの Agent を見つけ、所有者、権限、稼働状況を確認できます。",
        },
        {
          title: "Task をワークフローで進める",
          description:
            "Task は人にも Agent にも割り当てられます。Agent が完了するとレビュー、完了へ状態が進み、判断の記録が残ります。",
        },
      ],
      cta: "始める",
    ...
    openSource: {
      ...
      description:
        "Silieco は完全なオープンソースです。すべてのコードを確認し、自分の条件でセルフホストし、人間と AI エージェントが協働する未来を、ともに形づくっていけます。",
      cta: "GitHub でスターを付ける",
      highlights: [
        {
          title: "どこでもセルフホスト",
          description:
            "自社のインフラで Silieco を運用できます。Docker Compose、単一バイナリ、Kubernetes に対応。データがネットワークの外に出ることはありません。",
        },
        {
          title: "ベンダーロックインなし",
          description:
    ...
    faq: {
      ...
      items: [
        {
          question: "Silieco はどのコーディングエージェントに対応していますか?",
          answer:
            "Silieco は、Antigravity、Claude Code、CodeBuddy、Codex、Cursor、Copilot、Hermes、Kimi、Kiro CLI、OpenCode、OpenClaw、Pi、Qoder、Trae CLI の14種類のコーディングツールに標準対応しています。デーモンが、すでにインストール済みの CLI を自動検出し、それぞれをランタイムとして登録します。オープンソースなので、独自のバックエンドを追加することもできます。",
        },
        {
        ...
        },
        {
          ...
          answer:
            "コーディングエージェントは実行が得意です。Silieco はその上に、タスクキュー、チームの連携、スキルの再利用、ランタイムの監視、そして各エージェントの動きを一望できる統合ビューという管理レイヤーを加えます。エージェントのためのプロジェクトマネージャーだと考えてください。",
        },
        {
          question: "エージェントは長時間のタスクを自律的にこなせますか?",
          answer:
            "はい。Silieco は、キュー追加・受け取り・実行・完了または失敗まで、タスクのライフサイクル全体を管理します。エージェントは詰まったところを先に知らせ、進捗をリアルタイムにストリーミングします。好きなときに覗いてもよいですし、一晩じゅう走らせておくこともできます。",
        },
        {
          question: "コードは安全ですか? エージェントの実行はどこで行われますか?",
          answer:
            "エージェントの実行は、あなたのマシン(ローカルデーモン)、または自社のクラウドインフラ上で行われます。コードが Silieco のサーバーを経由することはありません。プラットフォームはタスクの状態を調整し、イベントを配信する役割だけを担います。",
        },
        {
    ...
    changelog: {
      title: "変更履歴",
      subtitle: "Silieco の新しいアップデートと改善点をお届けします。",
      toc: "すべてのリリース",
      categories: {
        features: "新機能",
        improvements: "改善",
      ...
      entries: [
        {
          ...
          improvements: [
            ...
            "Task テーブルのサイズ変更、並べ替え、読み込み、スクロールが滑らかになりました。",
        ...
        },
        {
          ...
          features: [
            ...
            "親 Task に、子 Task で作業中のエージェント数が表示されるようになりました。",
          ],
          improvements: [
            ...
            "多くのワークスペースがあっても、Silieco の起動時にエージェントツールを何度も確認しなくなりました。",
            "使用量ランキングが上位エージェントに絞られ、失敗の並び順も分かりやすくなりました。",
            "送信後のカーソルが、それぞれの入力画面に合った位置へ移動するようになりました。",
          ],
          fixes: [
            "Claude Code で長い Task の続きを処理するとき、繰り返しのキャッシュ書き込みが約 95% 減りました。",
            "Task を削除すると、開く前に見ていた一覧へ戻るようになりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "Task の一覧に戻ったとき、内容が最新の状態に保たれるようになりました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Task テーブルに、どのエージェントが作業中かが直接表示されます。",
          ...
          improvements: [
            ...
            "Task をさらに読み込むときに「読み込み中…」が表示され、最後まで来たことも分かるようになりました。",
          ],
          fixes: [
            "ボードとリストでスクロールして Task を追加読み込みしても、全画面のスケルトンが一瞬表示されなくなりました。",
        ...
        },
        {
          version: "0.4.9",
          date: "2026-07-23",
          title: "より詳しいサブ Task、Codex 高速モード、なめらかな UI",
          changes: [],
          features: [
            "Codex エージェントをより速い高速モードで実行できるようになりました。",
            "サブ Task に優先度・ラベル・進捗・期限が一目で表示されます。",
            "サブ Task ごとに表示する項目を選べるようになりました。",
          ...
          fixes: [
            ...
            "新規 Task の下書きで選んだオプションが失われなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            ...
            "Task の作成時にプロジェクトを選ぶと、プロジェクトのドロップダウンが閉じます。",
          ],
        },
        {
          version: "0.4.5",
          date: "2026-07-20",
          title: "カスタマイズできる Task テーブル、リアルタイムに並ぶボード、より安定したエージェント実行",
          changes: [],
          features: [
            "Task テーブルをカスタマイズし、表示する列とその並び順を自由に選べるようになりました。",
          ],
          improvements: [
            "Task に新しいコメントや更新が入った瞬間、ボードや一覧が自動で並び替わります。",
            "プロジェクト一覧の表示方法を、シンプルなドロップダウンで切り替えられます。",
            "送信ショートカットで Task をそのまま作成できるようになりました。",
          ...
          fixes: [
            ...
            "ダイレクト チャットの返信が Silieco 内に残るようになりました。",
            "AI による作成が常に使えるようになりました。",
            "Task ページが、最初に開くときにちらつかなくなりました。",
        ...
        },
        {
          ...
          improvements: [
            ...
            "Task の作成時に表示するフィールドを、設定から選べるようになりました。",
            "Task 一覧ページで、今何体のエージェントが動いているか分かりやすくなりました。",
            "お使いのマシンのエージェント サービスが、起動時のオプションを覚えるようになりました。",
            "同じ Task でのスクワッド リーダーの続きの作業が、前回の続きから再開します。",
        ...
        },
        {
          version: "0.4.3",
          date: "2026-07-16",
          title: "Task 専用ウィンドウ、受信トレイのアーカイブ、より安定したエージェント実行",
          changes: [],
          features: [
            "デスクトップ アプリで、任意の Task を専用ウィンドウで開けるようになりました。",
          ...
          improvements: [
            ...
            "メッセージの送信や Task の作成が添付の完了を待つようになり、ファイルが失われません。",
          ...
          fixes: [
            ...
            "Task の作成時に選んだラベルが、毎回 Task と一緒に保存されます。",
            "書式付きのテキストをコメントに貼り付けても、余計な ++ が残らなくなりました。",
            "アバターの上をただ通り過ぎただけで、ホバー カードが出なくなりました。",
            "Linux 版デスクトップ アプリが silieco-desktop という名前でインストールされます。",
          ],
        },
        {
          version: "0.4.2",
          date: "2026-07-15",
          title: "カスタム Task フィールド、担当者の表示、Grok エージェント",
          changes: [],
          features: [
            "Task に独自のカスタム フィールドを追加し、一覧でそのまま確認できるようになりました。",
            "各エージェントの実行の裏で、どのメンバーが担当しているかが分かるようになりました。",
            "Grok でエージェントを構築できるようになりました。",
            "エージェント一覧でアクセス範囲を表示し、絞り込みや一括編集ができるようになりました。",
            "Task のリンクが既定で新しいタブで開くようになり、設定で変更できます。",
            "コマンドラインからワークスペースを直接作成できるようになりました。",
            "ラベルやカスタム フィールドの色に、ランダムな配色を選べるようになりました。",
            "コマンド パレットから、Task のすべてのコメントを一度に折りたたみ・展開できます。",
        ...
        },
        {
          ...
          features: [
            ...
            "長い Task でも、新しいミニマップでコメントのスレッド間をすばやく移動できます。",
            "お使いのマシンに入っているスキルを、アプリからそのまま検索できます。",
            "お好みで、Task のコメント入力欄をスクロールしても固定したままにできます。",
          ...
          fixes: [
            "Task をキャンセル済みにしても、そこで実行中のエージェントの作業が中断されなくなりました。",
        ...
        },
        {
          version: "0.3.43",
          date: "2026-07-10",
          title: "新しい Codex モデル、Task 番号の自動リンク、アバターの切り抜き",
          changes: [],
          features: [
            "新しい Codex gpt-5.6 モデル（Sol、Terra、Luna）でエージェントを動かせるようになりました。",
            "SILI-123 のような Task 番号を入力または貼り付けると、自動でクリックできる Task リンクになります。",
          ...
          improvements: [
            ...
            "複数のサブ Task のステータスをまとめて変更すると、余計な確認なしにその場で反映されます。",
        ...
        },
        {
          ...
          features: [
            ...
            "キャンセルした Task が他のステータスと同じように、ボードや一覧に独立した列として表示されます。",
            "エージェントにカーソルを合わせると、詳細ページを開かずに使用中のモデルと思考の強さが分かります。",
          ],
          improvements: [
            "ネットワークが短時間途切れた後も、アプリがより確実に接続を回復します。",
            "コマンドラインから Task を割り当てるとき、一瞬の通信の乱れで失敗しなくなりました。",
          ],
          fixes: [
            "Task への追いコメントが失われなくなりました。エージェントの作業中に送っても必ず受け取られます。",
        ...
        },
        {
          version: "0.3.41",
          date: "2026-07-08",
          title: "マシン名、メンバー主導のスクワッド、CLI での Task 並び替え",
          changes: [],
          features: [
            ...
            "コマンドラインから Task を並び替え、正確な位置を指定できるようになりました。",
          ],
          improvements: [
        ...
        },
        {
          ...
          features: [
            ...
            "Task 詳細でページ内検索（Ctrl+F）が使え、一致箇所へジャンプしてハイライトできます。",
        ...
        },
        {
          ...
          fixes: [
            "プライベート リーダーのスクワッドで、サブ Task がエージェントによってクローズされたとき、複数ステージのフローが最初のステージで止まらなくなりました。",
            "親 Task の「サブ タスク完了」通知が、途中のステージを「最終ステージ」と誤って表示しなくなり、リーダーは「次のステージに進む」「まとめる」を自分で選べます。",
            ...
            "Task やコメントのエディターに長いスタックトレースや異常に長い文字列を貼り付けても、画面が固まらなくなりました。",
            ...
            "オートパイロットが、実行が長引いた際に同じ Task を続けて 2 回起動しないようになりました。",
            "Task の PR 一覧には、その Task を実際に対象にしている PR だけが表示され、本文で「Related to SILI-…」と触れているだけの PR は非表示になりました。",
            "Task アクション メニューの入れ子だった「More」項目が「Relations（関係）」に改名され、開かなくても中身が分かるようになりました。",
            "チャット、Task 作成、Task 説明、フィードバックなど全ての添付アップロード ボタンで、システムのファイル ダイアログから複数ファイルを一度に選べるようになりました。",
          ],
        },
        {
          version: "0.3.36",
          ...
          features: [
            ...
            "セルフホスト（Helm）：新しい `postgres.external.enabled` トグルで Silieco を外部管理の PostgreSQL（RDS、CNPG、Cloud SQL、Neon など）に向けられ、内蔵データベースをスキップできます。",
          ],
          fixes: [
            ...
            "ランタイムがオフラインでも、Autopilot の「Task を作成」実行がラン リストに残るようになりました。",
        ...
        },
        {
          version: "0.3.35",
          date: "2026-07-02",
          title: "サブ Task 表示トグル、より軽快な Task ビュー、より安全なエージェント CLI",
          changes: [],
          features: [
            "Task ビューに「サブ Task を表示」トグルが加わり、ボード・リスト・スイムレーン・ガントのどこでも親 Task に集中できます。",
            "手動の Task 作成ダイアログにラベル ピッカーが追加され、期限日は ⋯ オーバーフロー メニューに移動しました。",
          ...
          fixes: [
            "同じスクワッド内でサブ Task が完了したとき、親 Task のスクワッド リーダーが起動され、親 Task が in_progress のまま止まりません。",
            ...
            "インラインの base64 画像（QR コード、スクリーンショット、チャート）が Markdown と読み取り専用の Task コメントで正しく表示されます。",
            "コメントが Task 間を移動しても、添付リンクが元の添付を正しく解決し続けます。",
        ...
        },
        {
          version: "0.3.34",
          date: "2026-07-01",
          title: "Slack /task スラッシュ コマンド、ByteDance TRAE CLI ランタイム、Claude Sonnet 5 対応",
          changes: [],
          features: [
            "Slack のネイティブ /task スラッシュ コマンドで Silieco Task を作成し、実行者だけに Task リンクを私信で返します。",
            "同じ Slack ワークスペースで既に一方の Silieco ボットに連携済みのユーザーは、別のボットが加わっても再連携を求められなくなりました。",
          ...
          improvements: [
            ...
            "Task とコメントのエディターが Tiptap 3.27.1 に更新され、インライン `code` ショートカットの入力時に直前の文字が消えるまれな不具合が修正されました。",
          ],
          fixes: [
            ...
            "セルフホスト：docker-compose.selfhost.yml で SILIECO_SLACK_SECRET_KEY をバックエンド コンテナへ引き渡すようになりました。（コミュニティ報告）",
            "Task 一覧上部の「N 件処理中」チップが、エージェントではなく Task の数を数えるようになりました。",
            "セルフホストの匿名ソース チャネル送信先を正式な Silieco API エンドポイントに戻しました。",
        ...
        },
        {
          ...
          features: [
            ...
            "Slack チャンネルの過去のやり取りを Silieco にバックフィルでき、エージェントが加わった時点で会話の流れをそのまま把握できます。",
            "Slack でエージェントが返信を準備している間、ユーザーのメッセージに 👀 のリアクションが付き、終了時に確実に外れます。",
            "スキル パッケージをローカルの .skill / .zip アーカイブから取り込めるようになりました。",
            "silieco task 系のコマンドは短い UUID プレフィックスを受け付けなくなりました。Task Key（SILI-123）または完全な UUID を指定してください。",
        ...
        },
        {
          version: "0.3.32",
          date: "2026-06-29",
          title: "サブ Task の切り離し、より堅牢なデーモン再接続、どこからでも開ける添付プレビュー",
          changes: [],
          features: [
            "Task のアクションに「親 Task を解除」が追加され、別の親を選び直さなくても子 Task を直接切り離せます。",
          ],
          improvements: [
          ...
          fixes: [
            ...
            "失敗タスク ハンドラーが詰まった Task を解除すると、Task 表示が即座に更新され、手動リロードが不要になりました。",
            "Task コメントの sticky ヘッダーがハイライトのフェードと同じ背景遷移を共有し、固定切り替えの違和感がなくなりました。",
        ...
        },
        {
          ...
          fixes: [
            "Task エディター内のリストで Tab を押すと、選択した項目が安定して字下げされ、カーソルがリストの外に飛ばなくなりました。",
            "コメントの @メンションでスクワッド リーダーに依頼すると、スクワッドのブリーフィングを携えて起動し、親メンションを引き継いだ返信が再度トリガーすることもありません。",
            "Task やコメント内のコード ブロックで選択したテキストが、画面の別領域が再描画されても解除されなくなりました。",
            "Task を特定のエージェントに直接アサインすると、ハンドオフ メモ欄がそのまますぐに開きます。",
            "ワークスペース切替メニューの未読ドットが、実際のインボックス表示と一致するようになりました。",
            "Task のコメント編集時、保存ボタンに明確なローディング表示が出るようになりました。",
            "検索結果が再び安定して読み込まれます。",
        ...
        },
        {
          ...
          features: [
            ...
            "Task エディター上で Tab を押すと、ハイライト中の @メンションや候補がそのまま挿入され、相手や Task を 1 回のキー操作で選べます。",
          ...
          fixes: [
            ...
            "Task を別プロジェクトに移すと旧プロジェクトの一覧からすぐに外れ、ボード表示外でステータスが変わってもカラムの件数が正しく揃います。",
            ...
            "Task のクイック作成で複数ファイルを同時にアップロードしても、すべての添付が確実に残ります。",
            "Redis ベースの Webhook レート制限が無関係な Webhook を巻き込まなくなり、大きなスキルパックを含めてデーモンが安定して読み込めるようになりました。",
            "Task ラベル名は制御文字を受け付けなくなり、どの画面でもラベルが読みやすく保たれます。",
          ],
        },
        {
          version: "0.3.29",
          ...
          features: [
            ...
            "エージェントが長い Task 議論を読むとき、解決済みスレッドが要点となる結論まで自動で折りたたまれ、コンテキストがより集中します。",
          ...
          fixes: [
            "親 Task 内の子 Task が作成順で安定して表示されます。",
            "Task 内の添付ファイルプレビューが正しく開けるようになりました。",
            "@メンション候補は、検索結果の並びが変わってもハイライト中の人または Task を正しく選びます。",
            "キャンセルしたチャット下書きを削除すると、画面を移動して戻っても再表示されなくなりました。",
            "オートパイロットのコールドスタート、Task ヘッダーのエージェント状態、Antigravity のプロバイダーエラー表示がより正確になりました。",
          ],
        },
        {
          version: "0.3.28",
          date: "2026-06-23",
          title: "子 Task のステージ対応と Qoder ランタイム対応",
          changes: [],
          features: [
            "子 Task をステージごとに整理できるようになり、同じステージの作業を並行して進め、ステージ完了時だけ親 Task に更新できます。",
            "Task を割り当て・一括更新する際に、エージェントを起動するか（どのエージェントか）を事前に確認できるようになり、実行を起こさずに変更だけ適用できます。起動する場合は、その実行のコンテキストとしてエージェントに渡される引き継ぎメモを添えられます。",
          ...
          improvements: [
            ...
            "コマンドラインでコメントの解決状態、Task の利用状況サマリー、オートパイロットの購読者管理を扱えるようになりました。",
            "読み取り専用コードブロックにコピーボタンが付き、ウェブサイトの GitHub ボタンには現在のスター数が表示されます。",
            "新しいデーモンではエージェントスキルの受け渡しがより効率的になり、古いデーモンとの互換性も保たれます。",
          ],
          fixes: [
            "Task の一括編集メニューで、選択した Task に共通するステータス、優先度、担当者が正しく表示されます。",
            "ボードやリストで Task をドラッグしても、カードが元の位置に戻ってから移動するちらつきが起きにくくなりました。",
        ...
        },
        {
          ...
          improvements: [
            "Task ヘッダーのエージェント活動はホバーで開けるようになり、進行中の作業をすばやく確認できます。",
          ...
          fixes: [
            "親 Task がバックログにある場合、子タスク完了後も意図しない自動処理は起動しません。",
        ...
        },
        {
          ...
          features: [
            ...
            "オートパイロットに既定の購読者を設定でき、新しい Task の確認に必要なチームメイトを含めやすくなりました。",
            "チャット添付ファイルは現在のワークスペースに結び付き、送信中も会話を続けやすくなりました。",
            "失敗したエージェントコメントを Task タイムラインから直接再試行できます。",
          ],
          improvements: [
          ...
          fixes: [
            "チャットとコメント内の Task メンションチップが枠内に収まり、周辺テキストと重なりません。",
        ...
        },
        {
          ...
          improvements: [
            ...
            "Task コメントのトリガープレビューが読みやすくなりました。",
          ],
          fixes: [
            ...
            "不明な Task アイコンと通常のファイル名リンクを安全に扱います。",
          ],
        },
        {
          version: "0.3.23",
          date: "2026-06-16",
          title: "Task の日付フィルターとエージェント実行の安定性向上",
          changes: [],
          features: [
            "Task を作成日または更新日で絞り込めるようになり、クイック期間やカスタム日付を選べます。",
          ...
          fixes: [
            ...
            "コメント内の通常の Task 番号は、明示的にリンクしない限り通常のテキストのまま残ります。",
        ...
        },
        {
          version: "0.3.22",
          date: "2026-06-15",
          title: "より速いリスト体験、使いやすい実行設定、安全な Task 編集",
          changes: [],
          features: [
            ...
            "Cursor と OpenClaw の設定が簡単になりました。Cursor の接続設定は Silieco に任せられ、OpenClaw は既存のゲートウェイにも接続できます。",
            "コメントを編集するとき、保存前にどのエージェントやスクワッドが動き始めるかをプレビューして制御できます。",
          ],
          improvements: [
            "デスクトップの復旧案内にページの文脈が増え、固まったウィンドウを報告するときに状況を伝えやすくなりました。",
            "長い Task と受信箱ビューでは、別の場所へ移動して戻ったときにスクロール位置やコメント位置がより安定して保たれます。",
            "Cursor の Composer、キャッシュ入力、新しい Cursor エージェント出力で、使用量と請求情報がより分かりやすく表示されます。",
          ],
          fixes: [
            "Task の添付ファイル、本文内画像、ファイルカードは、Web、デスクトップ、モバイル、トークン付き共有リンクでより安定して開けるようになりました。",
            "エディターと読み取り専用の Task 内容で、ドル金額とメールリンクがより安定して扱われます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "CodeBuddy でローカルの Silieco エージェントを動かせるようになり、利用できるモデルと実行の強さが自動で表示されます。",
            "クイック作成した Task では、下書きでアップロードしたファイルが最終的な Task まで保持されます。",
          ],
          improvements: [
        ...
        },
        {
          ...
          fixes: [
            "Taskの返信は到着した順番のまま表示され、遅れて届いたエージェント返信が途中に割り込まなくなりました。",
            "保存済みセッションが失われた場合でも、エージェントは新しく開始して復旧でき、以後のメンションで失敗し続けません。",
            "新しい作業フォルダーからTaskを再開すると、古いフォルダーにだけ存在したセッションではなく新しいセッションで始まります。",
          ],
        },
        {
          version: "0.3.19",
          ...
          features: [
            ...
            "Claude Fable 5 が Silieco の対応モデルと料金一覧に加わりました。",
            "Taskの会話で特定の返信を解決として残せるようになり、長いスレッドを閉じても結論を確認しやすくなりました。",
            "Lark と Feishu の会話では、Silieco が返信を準備している間に入力中のリアクションを表示し、返信前に自動で消します。",
          ...
          improvements: [
            ...
            "WSL2 など Silieco の外でデーモンが管理されている場合、デスクトップは開始と停止の操作を無効にします。",
            "Task上部のアクティブなエージェント表示は、実行中だけ動き、待機中は待機状態を明確に示すため、読み取りやすくなりました。",
            "CLI は、よくあるエラー、サインインの問題、プロジェクト設定の値について、よりわかりやすく案内します。",
          ],
          fixes: [
            "Task説明内の画像とファイルは、Web とデスクトップのどちらでも再読み込み後に表示され続けます。",
            "各Task会話スレッドは解決済みの回答を 1 つだけ保持するため、結論を置き換えたときの表示が全員でそろいます。",
            "リアルタイム接続が復帰したあと、Task画面はデータを更新し、古いタイムラインが残りにくくなりました。",
            "エージェントタスクの開始者履歴が、古いタスク記録でもより信頼できるようになりました。",
            "スクロール中の固定Taskコメントの境界がよりきれいに表示されます。",
            "新しく投稿された添付ファイルは安定した非公開ダウンロードリンクを使うため、一時的なアップロードリンクが期限切れになっても画像やファイルを表示できます。",
            "新規Taskから始まったオートパイロット実行は、割り当てられたタスクが完了できない場合に正しく失敗し、進行中のまま残りません。",
            "受信箱からコメントリンクを開いたとき、デスクトップ画面全体ではなくTaskのタイムラインだけがスクロールします。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Web アプリでブラウザー標準の通知バナーを表示できるようになり、Silieco がバックグラウンドでもワークスペースの動きに気づきやすくなりました。",
          ...
          improvements: [
            "Taskのヘッダーにエージェントのライブ表示が移動し、よりコンパクトで確認しやすくなりました。",
        ...
        },
        {
          ...
          improvements: [
            "大きなTask説明や長い Markdown 下書きが、エディターでより速く開きます。",
            ...
            "Taskのコメントと返信入力欄は、余分な展開ボタンなしで入力に合わせて伸びる、よりすっきりした表示になりました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Silieco は Lark のサードパーティ連携に対応し、QR コードを読み取るだけで Silieco エージェントを Lark Bot として作成できます。",
            "チャットに検索できるエージェント選択と明示的なコンテキスト選択が加わり、誰に任せるか、何を見せるかを選びやすくなりました。",
            "説明とコメントでチェックボックス付きタスクリストを使えるようになり、Task内の軽い計画を整理しやすくなりました。",
            "エージェントに Silieco の組み込みスキルが加わり、ワークスペースの進め方により沿いやすくなりました。",
          ],
          improvements: [
          ...
          fixes: [
            ...
            "CLI はTaskのメタデータがない場合、エラーではなく空の結果として扱います。",
          ],
        },
        {
          version: "0.3.15",
          ...
          fixes: [
            "Taskの開始日と期限日が、タイムゾーンをまたいでも選択した日付のまま保たれます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "Silieco がアプリ、サイト、ドキュメントで日本語に対応しました。",
          ...
          improvements: [
            ...
            "チャット履歴とTaskの実行履歴で、ホバー時の操作が見やすくなり、文字の省略や重なりが減りました。",
            "プロジェクト内のTaskでは、エージェント作業中フィルターがリスト、ボード、タイムラインで一貫して効きます。",
          ],
          fixes: [
            "権限のないユーザーが、間接的なTask操作やコメントからプライベートなスクワッドリーダーを起動できないようにしました。",
        ...
        },
        {
          version: "0.3.12",
          date: "2026-05-29",
          title: "Taskのセッション再開と韓国語対応",
          changes: [],
          features: [
            "エージェントがTaskのコメントから作業を続けるとき、新しいセッションを作らずに前のセッションを再開し、タスクのコンテキストをそのまま引き継ぎます。",
            "Silieco がアプリ、ウェブサイト、ドキュメントで韓国語に対応し、韓国語のドキュメントページや日付表示のローカライズも提供します。",
            "Task画面で作業中のエージェントをタイトルの近くに表示し、複数のエージェントが同時に作業しているときも見やすくなりました。",
            "エージェントはTaskの議論を読むとき、スレッドのプレビュー、返信数、最近のアクティビティを先に確認し、必要なコンテキストをより速く見つけられます。",
            "OpenClaw ランタイムがエージェントに保存された MCP 設定を使えるようになり、モデル選択や使用量の見積もりでも Claude Opus 4.8 を利用できます。",
          ],
          improvements: [
            "詳細ページのパンくずヘッダーが統一され、Task、プロジェクト、ランタイム、スキル、エージェント、スクワッドの一貫性が高まりました。",
            "再開したエージェントのタスクは、すでに読んだコメントを読み直す時間が減り、もとの議論へより速く戻れます。",
            "Taskのメンション案内と CLI コマンドの表示が読みやすくなり、より安全にコピーできるようになりました。",
          ],
          fixes: [
            "エージェントのスキルが、更新・アーカイブ・復元・テンプレート作成・環境変更のあとも引き続き正しく表示されます。",
            "ひとつのエージェントに割り当てられた親Taskが、そのエージェントが子Taskを完了したあとも継続します。",
        ...
        },
        {
          ...
          features: [
            ...
            "スイムレーン表示が親Task・プロジェクト・担当者でTaskをグループ化できるようになり、大きなボードもチームの計画方法に合わせて見渡せます。",
          ],
          improvements: [
            "中国語の製品表記が、ナビゲーション・設定・検索・ランタイム画面で一貫性を増し、共通画面のアクセシビリティと React コードも整理されました。",
          ],
          fixes: [
            "スイムレーン、サブTask作成、予約されたオートパイロットのタイトル、コメント編集、コードブロック、アバターのパス、ランタイム診断に関する不具合を修正しました。",
          ],
        },
        {
          version: "0.3.9",
          date: "2026-05-26",
          title: "スイムレーンと、より予測しやすいTask",
          changes: [],
          features: [
            "Taskにスイムレーン表示が加わり、大規模プロジェクトの親作業とステータス列をまとめて見渡せるようになりました。",
            "Task一覧がドラッグ&ドロップでの並べ替え、固定されたグループヘッダー、追加読み込み後も安定した並び順に対応しました。",
          ],
          improvements: [
            "CLI のステータス出力、セルフホストの使用量に関する案内、エージェントのスキル設定、依存関係チェックが、より明確になりました。",
          ],
          fixes: [
            "GitHub PR の自動クローズ条件、親 / 子Taskの自動化、Taskスレッドの順序、ボードのドラッグ位置、チャットのサイズ変更に関する不具合を修正しました。",
          ],
        },
        {
          version: "0.3.8",
          ...
          changes: [],
          features: [
            "初めて実用的なモバイルクライアントとなる Silieco for iOS をリリースし、ログイン・ワークスペース・インボックス・Task・プロジェクト・チャット・コメント・リアルタイム更新をすべて利用できます。",
          ...
          fixes: [
            "Taskタイムラインの順序、Codex と Pi の実行入力の処理、ローカルランタイムの削除、タイトルの再読み込み、Markdown コードの表示に関する不具合を修正しました。",
          ],
        },
        {
          version: "0.3.6",
          ...
          changes: [],
          features: [
            "新規ユーザーは、Sili Agent がワークスペースの紹介、ツアー、ウェルカムページ作成まで案内する新しいオンボーディング体験を利用できます。",
            "Task一覧でどのエージェントが作業中かが表示され、詳細表示や「作業中」フィルターも利用できます。",
            "子Taskが完了すると親Taskにもプラットフォームによる更新が残り、適切な担当者にも通知が届きます。",
          ],
          improvements: [
            "Taskのボードカード、Task作成のプロパティバー、シークレット値の表示制御、ワークスペース一覧の読み込み、Helper の案内が改善されました。",
          ],
          fixes: [
        ...
        },
        {
          version: "0.3.5",
          date: "2026-05-21",
          title: "ローカルタイムゾーンの使用量とTaskのカスタム KV",
          changes: [],
          features: [
            "使用量画面がユーザーの表示タイムゾーンを反映し、ワークスペースとランタイムの使用量を、ユーザーが想定する日付の区切りで表示します。",
            "Taskにエージェント向けのコンパクトな状態を保存できるようになり、自動化の進捗がサイドバーを散らかさずに、その作業項目に紐付きます。",
            "長いTaskの議論を最新の返信から読めるようになり、プロジェクト一覧にもコンパクト / 快適なレイアウトが加わりました。",
          ],
          improvements: [
            "CLI のワークスペースコマンド、モデル選択、セルフホストとエージェントのドキュメント、予約パスの保護、ランタイムのメタデータに関する案内が整理されました。",
          ],
          fixes: [
            "Codex の再試行、Claude Code の使用量記録、壊れたリアルタイムメッセージの処理、Task作成ボタンの案内、ランタイムのタスク復旧を修正しました。",
          ],
        },
        {
          version: "0.3.4",
          ...
          changes: [],
          features: [
            "オートパイロットがスクワッド経由で新しい作業を割り当て、作成したTaskを指定したプロジェクトに直接入れられるようになりました。",
          ...
          improvements: [
            "新規ユーザーのランタイム接続、ランタイムページ、Taskのパンくず、HTML / 添付プレビュー、スクワッドのアーカイブ確認、親 / 子Taskの案内が改善されました。",
          ],
          fixes: [
        ...
        },
        {
          version: "0.3.3",
          date: "2026-05-19",
          title: "プロジェクトタイムラインと、より明確なTask作業",
          changes: [],
          features: [
            "プロジェクトにガントチャート表示が加わり、予定のある作業を計画の変更に合わせて確認できるようになりました。",
            "ワークスペース管理者はTaskキーの接頭辞を変更でき、CLI はワークスペースの切り替えと現在のワークスペースの表示に対応します。",
            "エージェントは最新のTask議論から読めるようになり、使用量画面やエージェント詳細ボードも改善されました。",
          ],
          improvements: [
            "オンボーディングの質問の流れ、マイTaskでのスクワッド作業の表示、エージェント実行ログの並べ替えが改善されました。",
          ],
          fixes: [
            "デスクトップの HTML プレビュー、HTML ソース表示、Task作成モードの切り替え、ランタイムのタスクコンテキスト、セルフホストのセッション期間設定を修正しました。",
          ],
        },
        {
          version: "0.3.2",
          ...
          features: [
            ...
            "Taskボードが担当者ごとのグループ化、連携した Pull request の状態、開始日の表示に対応します。",
            "ランタイムページのマシンビュー、時間 / タスクの使用量チャート、スキルの一括コピー、HTML プレビューが加わりました。",
          ],
          improvements: [
            "失敗したTask操作のエラー、GitHub PR の状態表示、セルフホストの初期値、検索結果の品質が改善されました。",
          ],
          fixes: [
            "オートパイロットが作成したTaskの繰り返し、ランタイムの初期選択、スクワッドのスクロール、デスクトップのズーム、認証 / ローカルサービスの安定性を修正しました。",
          ],
        },
        {
          version: "0.3.1",
          ...
          improvements: [
            "ページ遷移、長いTaskのアクティビティの折りたたみ、Agents / Squads 一覧の表示の記憶、SSH リポジトリ URL の処理、スクワッドの引き継ぎが改善されました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          fixes: [
            "スクワッドリーダーのルーティング、スクワッドのメンション、Task一覧の更新、添付プレビューの不具合を修正しました。",
          ],
        },
        {
          version: "0.2.32",
        ...
        },
        {
          version: "0.2.31",
          date: "2026-05-12",
          title: "GitHub 連携と、より安全なTaskナビゲーション",
          changes: [],
          features: [
            "GitHub を接続して、連携した Pull request を Silieco のTaskに表示し、状態を同期し、PR がクローズされたときにTaskを自動的に閉じられます。",
            "チャットメッセージの添付ファイルと画像プレビューに対応し、エージェントとランタイムの公開範囲を設定できます。",
            "単一のエージェントタスクを停止する前に確認を求め、GitHub 連携のドキュメントを提供します。",
          ],
          improvements: [
            "Taskリンクの正確さ、長いTaskタイムラインのスクロール、フィードバックの GitHub 案内、セルフホストの Caddy 案内、Linux のアプリアイコンが改善されました。",
          ],
          fixes: [
            "添付ファイル名、ローカル添付の配信、Task作成ダイアログの高さ、ランタイムのドキュメントリンクを修正しました。",
          ],
        },
        {
          version: "0.2.30",
          date: "2026-05-11",
          title: "Mermaid Task、ランタイムごとのタイムゾーン、退出時のランタイム失効",
          changes: [],
          features: [
            "Taskの説明で Mermaid 図をレンダリングし、サブTaskの行に状態と担当者の picker が加わりました。",
          ...
          fixes: [
            "最近のTaskの漏れ、添付ダウンロード URL、Windows での入力、デーモンのコンソールポップアップ、Pi のツールフィルター、インボックスの移動、オートパイロットの CLI モードなどを修正しました。",
          ],
        },
        {
          version: "0.2.29",
          ...
          features: [
            ...
            "コメントスレッドを解決して折りたためるようになり、Taskの live banner がキュー待ちのエージェントタスクを表示します。",
            "失敗またはキャンセルされたタスクを、実行ログからワンクリックで再実行できます。",
          ],
          improvements: [
            "Taskタイムラインのレンダリング、大きな貼り付けの処理、オートパイロットのオフライン dispatch の回避、インボックスの自動アーカイブ、Hermes のリクエスト受け渡しが改善されました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`silieco daemon disk-usage` が、タスクごと・ワークスペースごとのディスク使用量を表示します。",
            "エージェント設定のスキル picker に検索ボックスが加わり、デーモンの GC 範囲がチャット、オートパイロット、quick-create のタスクまで広がりました。",
            "Task詳細のパンくずに、すばやく参照できる識別子が表示されます。",
          ],
          improvements: [
        ...
        },
        {
          ...
          improvements: [
            "チャットとインボックス、Taskの作業アクション、オートパイロットの繰り返し失敗の検出が、よりなめらかになりました。",
          ],
          fixes: [
            "中国語入力、デスクトップの更新、長いTaskタイムライン、live status 更新の安定性を改善しました。",
          ],
        },
        {
          version: "0.2.26",
          ...
          improvements: [
            "設定タブの名称と URL への反映、長いTaskタイムライン、ランタイムの poll / heartbeat の分離、Redis ベースの CLI 更新リクエスト、使用量クエリの範囲が改善されました。",
          ],
          fixes: [
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`silieco repo checkout --ref` が、ブランチ、タグ、特定のコミットを対象にリポジトリを取得できます。",
            "`silieco agent avatar` が、CLI からエージェントのアバターを直接アップロードします。",
            "インボックスの Done タスクにアーカイブボタンが加わり、重複していた mark-as-done の hover ボタンは削除されました。",
          ],
          improvements: [
            "長いタイムラインのTaskを開く処理、multi-replica のモデル picker、デーモンの empty-claim cache TTL が改善されました。",
          ],
          fixes: [
            "新しいエージェントの即時表示、Hermes の以前の回答の再生、Codex の GPT-5.5 モデル表示、`silieco login --token`、CLI 更新の状態、session resume、Kanban 設定、オートパイロットのレスポンシブ対応などを修正しました。",
          ],
        },
        {
          version: "0.2.21",
          ...
          changes: [],
          features: [
            "従来の新規Taskダイアログが Quick Capture に置き換わり、連続作成、ファイルアップロード、貼り付けた URL からの自動補完に対応します。",
            "Mermaid 図が Markdown の中でレンダリングされ、複雑なグラフは全画面の lightbox で確認できます。",
            "プロジェクトごとのリポジトリ紐付けと、権限を認識する UI が加わりました。",
          ],
          improvements: [
            "デーモンの claim polling の Redis fast-path、Silieco Agent のコミットの Co-authored-by trailer、デスクトップの reload 抑止が改善されました。",
          ],
          fixes: [
        ...
        },
        {
          version: "0.2.20",
          date: "2026-04-29",
          title: "エージェントによるTask作成と Presence v3",
          changes: [],
          features: [
            "`c` を押して一行を書き、エージェントを選ぶと、エージェントが非同期でTaskを作成し、結果をインボックスに残します。",
            "Agent Presence v3 が availability と last-task をより明確に分け、実行ログをTaskパネルに表示します。",
            "デーモンとサーバーの heartbeat が WebSocket で流れ、task startup latency が短くなりました。",
          ],
          improvements: [
            "PAT / daemon token のキャッシュ、agent CLI args の env var、手動 / エージェントのTask作成ダイアログの共有が改善されました。",
          ],
          fixes: [
            "エージェントによるTask作成の queue 停滞と重複作成、改行のレンダリング、agent-authored の mention loop、Windows Cursor の multi-line prompt を修正しました。",
          ],
        },
        {
          version: "0.2.19",
          ...
          features: [
            ...
            "macOS の dock badge と native notification が加わり、未読のTaskへ直接移動できます。",
            "Task一覧がラベルフィルターに対応し、デーモンが WebSocket で task wakeup を受け取ります。",
          ],
          improvements: [
        ...
        },
        {
          version: "0.2.18",
          date: "2026-04-27",
          title: "Taskラベルと Labs タブ",
          changes: [],
          features: [
            "Taskラベルで、list、board、detail view での色分けとフィルタリングができます。",
        ...
        },
        {
          ...
          changes: [],
          features: [
            "`silieco agent create/update --custom-env KEY=VALUE` が、エージェントの実行にカスタム環境変数を注入します。",
          ...
          fixes: [
            "Taskの create/update における assignee_id の検証、DeleteTask の ID 解決、Pi skills のパス、Windows console popup を修正しました。",
          ],
        },
        {
          version: "0.2.16",
          date: "2026-04-25",
          title: "Chat V2 とTaskの右クリックメニュー",
          changes: [],
          features: [
            "Chat V2、Taskの右クリックメニュー、アプリ内フィードバックの流れが加わりました。",
          ],
          improvements: [
            "チャットの使い勝手、Task操作のアクセシビリティ、フィードバック収集の流れが改善されました。",
          ],
          fixes: [
            "チャットとTask周辺の安定性の問題を修正しました。",
          ],
        },
        {
          version: "0.2.15",
        ...
        },
        {
          version: "0.2.7",
          date: "2026-04-16",
          title: "エディターからのサブTaskと MCP",
          changes: [],
          features: [
            "エディターの選択範囲からサブTaskを作成でき、セルフホストの gating と MCP 関連の機能を利用できます。",
          ],
          fixes: [
            "サブTask作成とセルフホスト設定周辺の問題を修正しました。",
          ],
        },
        {
          version: "0.2.5",
        ...
        },
        {
          version: "0.1.20",
          date: "2026-03-25",
          title: "サブTask、TanStack Query、使用量トラッキング",
          changes: [
            "サブTask、TanStack Query ベースのデータの流れ、使用量トラッキングを追加しました。",
          ],
        },
        {
          version: "0.1.18",
          date: "2026-03-23",
          title: "OAuth、OpenClaw、Task読み込み",
          changes: [
            "OAuth、OpenClaw ランタイム、Task読み込みの改善を追加しました。",
          ],
        },
        {
          version: "0.1.17",
    ...
    about: {
      title: "Silieco について",
      nameLine: "Silieco はオープンな Agent Work OS です。",
      paragraphs: [
        "Silieco は、人と AI エージェントが計画・実行・レビューを共有する一つのワークスペースです。Task、会話、承認、成果物、ランタイムの活動が最初から最後までつながります。",
        "製品は三つの明確な層で構成されます。App は共同作業の場、Core はID・状態・ポリシー・リアルタイム調整を担う制御面、Daemon はチーム管理下のコンピューターにあるエージェントランタイムを接続する実行面です。",
        "エージェントは正式なチームメンバーとしてTaskを受け取り、進捗や障害を報告し、結果を届けます。人は優先順位と最終承認を常に管理できます。",
        "Silieco はオープンソースでセルフホスト可能です。作業データとランタイム認証情報は、チームが管理するインフラに残ります。",
      ],
      cta: "GitHub で見る",
    },
    download: {
    ...
    contactSales: {
      pageTitle: "営業に相談",
      pageDescription:
        "人間と AI エージェントが協働するワークフローを社内に導入する方法について、Silieco チームにご相談ください。",
      eyebrow: "営業に相談",
      ...
      fields: {
        ...
        companySize: "会社規模",
        countryRegion: "国 / 地域",
        useCase: "Silieco をどのように利用、または活用するご予定ですか?",
        goals: "目標または現在抱えている課題",
        goalsHint:
          "Silieco で実現したいことや、いま直面している課題をお聞かせください。詳しくご記入いただくほど、より的確にお手伝いできます。",
      ...
      useCases: [
        ...
        { value: "adopt_team", label: "チームまたは会社に Silieco を導入" },
        { value: "self_host", label: "自社インフラにセルフホスト" },
        { value: "integrate", label: "既存ツールと Silieco を連携" },
      ...
      consent: {
        intro:
          "Silieco, Inc. はあなたのプライバシーを尊重します。お預かりした個人情報は、アカウントの管理と、ご依頼いただいた製品・サービスの提供のためにのみ使用します。ときどき、製品アップデートやベストプラクティス、ご参考になりそうなインサイトもお届けできればと思います。ご希望の場合は、下でお知らせください。",
        outreach:
          "サービスのアップデート、サポートへのお問い合わせ、ビジネス関連のフォローアップなど、Silieco, Inc. からの個別のご連絡を受け取ります。",
        updates:
          "Silieco からの製品アップデート、インサイト、イベントへのご招待を受け取ります。",
        unsubscribe:
          "配信はいつでも停止できます。データの取り扱いとプライバシーの権利について詳しくは、こちらをご確認ください:",
        submitConsent:
          "「送信」をクリックすると、ご依頼いただいたコンテンツをお届けするために、Silieco, Inc. が情報を保存・処理することに同意したことになります。",
      ...
      success: {
        ...
        message:
          "Silieco チームのメンバーが、3営業日以内にご返信いたします。それまでの間、ドキュメントを覗いてみたり、GitHub でスターを付けたりしてお待ちください。",
        cta: "ホームに戻る",
      },
      errors: {
