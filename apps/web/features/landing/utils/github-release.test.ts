...
const SAMPLE_LATEST_ASSET = {
  name: "silieco-desktop-0.2.14-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/silieco-ai/silieco/releases/download/v0.2.14/silieco-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "silieco-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/silieco-ai/silieco/releases/download/v0.2.13/silieco-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/silieco-ai/silieco/releases/tag/${overrides.tag}`,
