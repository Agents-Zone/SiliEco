...
import { createBrowserCookieLocaleAdapter } from "@silieco/core/i18n/browser";
import type { LocaleResources, SupportedLocale } from "@silieco/core/i18n";
...
// cookie mode on their next logout/login cycle (logout clears silieco_token).
// Sunset: once telemetry shows <1% of sessions still carry silieco_token,
...
function hasLegacyToken(): boolean {
  ...
  try {
    return Boolean(window.localStorage.getItem("silieco_token"));
  } catch {
    return false;
  }
}
