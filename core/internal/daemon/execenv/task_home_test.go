...
func TestRenderManagedBlockWritableRoots(t *testing.T) {
	...
	policy.WritableRoots = []string{"/home/u/silieco_workspaces/ws/abc/home", "/home/u/silieco_workspaces/.repos/ws"}

	block := renderSiliecoManagedBlock(policy)

	if !strings.Contains(block, `sandbox_workspace_write.writable_roots = ["/home/u/silieco_workspaces/ws/abc/home", "/home/u/silieco_workspaces/.repos/ws"]`) {
...
func TestRenderManagedBlockNoWritableRoots(t *testing.T) {
	...
	linux := renderSiliecoManagedBlock(codexSandboxPolicyFor("linux", "0.121.0"))
	...
	block := renderSiliecoManagedBlock(darwin)
