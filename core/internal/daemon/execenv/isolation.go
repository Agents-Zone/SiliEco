...
// in the silieco binary. The daemon runs Prepare/Reuse in that subprocess so a
...
const PreparationHelperArg = "__silieco_execenv_prepare"
...
// name the current silieco binary followed by PreparationHelperArg in
