...
//   - populates the task-local `skills/` dir with ONLY the Silieco-bound skills,
...
//     per-agent memory is a Silieco product concern — the host's local Hermes
...
const hermesTaskLocalStateMarker = ".silieco-task-local-state-v1"
...
// Silieco-bound skills. They keep their natural slug (no user skills share this
