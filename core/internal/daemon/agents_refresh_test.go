...
// TestDiscovery_RegistersCLIInstalledAfterStartup is the SILI-5439 regression
...
// TestHealth_ReportsSkippedAgents covers the diagnostic half of SILI-5439: a CLI
