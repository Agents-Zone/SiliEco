...
// TestSyncWorkspaces_ProbesBuiltinCLIsOncePerBatch is the SILI-5225 regression:
...
// used to strand the desktop runtime step in its empty state (SILI-5119).
...
// vanishedPinnedPath lays out the SILI-4486 shape a probe retry has to reckon
...
// re-resolved candidate (SILI-4486) — which can burn the full 10s timeout on its
