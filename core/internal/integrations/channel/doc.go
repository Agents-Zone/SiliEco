// Package channel is the platform-agnostic foundation for Silieco's
...
// given platform's event JSON looks like — design tracked in SILI-3506,
// phase-1 foundation in SILI-3515.
//
...
//
// Boundary rule (SILI-3515 decision §2): the envelope holds ONLY fields
...
// are wired in the follow-up cutover (see SILI-3515).
package channel
