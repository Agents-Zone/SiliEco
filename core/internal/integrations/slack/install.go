...
// This file is the Slack install backend (SILI-3666). Slack uses the
...
// app-level token (xapp-) into Silieco (the paste path lives in byo_install.go).
...
var (
	...
	// already connected to a live owner in a DIFFERENT Silieco workspace — it
	...
	ErrTeamOwnedByAnotherWorkspace = errors.New("slack: this Slack app is already connected to a different Silieco workspace")
...
// the pasted Slack app is already connected to a DIFFERENT agent or Silieco
