...
// TestLarkJSONFrameDecoderGroupMentionUnionID exercises the SILI-2671
...
// the SILI-2951 example. Body.content is the JSON-encoded post object; we
...
func TestLarkJSONFrameDecoderPostMessageFlattened(t *testing.T) {
	t.Parallel()
	postContent := `{"title":"周报","content":[[{"tag":"text","text":"本周完成："}],[{"tag":"text","text":"Lark 集成"},{"tag":"a","href":"https://github.com/silieco-ai/silieco/pull/3277","text":"PR #3277"}]]}`
	...
	want := "周报\n本周完成：\nLark 集成 PR #3277 (https://github.com/silieco-ai/silieco/pull/3277)"
	if msg.Body != want {
