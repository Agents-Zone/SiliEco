...
// TestEnrichRecentContextGroupMention is the SILI-3084 core: a bare @-bot
...
// TestEnrichRecentContextResolvesNames covers the SILI-3084 follow-up:
...
//
// It also pins the SILI-3084 review fix: the quoted parent's sender
...
func TestEnrichForwardedResolvesNames(t *testing.T) {
	...
	fake.byID["om_forward"] = []LarkMessage{
		...
		textMsg("c1", "ou_jiayuan", "你们线上的 Silieco 能用吗", "1000"),
