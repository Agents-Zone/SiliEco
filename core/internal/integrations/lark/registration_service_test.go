...
// QR URL: "<agent> - Silieco", with a blank agent name degrading to
// plain "Silieco" rather than a dangling " - Silieco".
...
// SILI-3059 fix: a completed install must publish lark_installation:created
