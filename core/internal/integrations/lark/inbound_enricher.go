...
// SILI-3084 (the Bot saw only the single @-ed line, never the surrounding
...
// turn is an accepted product decision for SILI-3084. It does NOT relax
// the SILI-2671 drop-audit invariant: a non-addressed group message still
