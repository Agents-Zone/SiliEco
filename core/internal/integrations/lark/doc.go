// Package lark contains the Silieco ↔ 飞书 (Lark) Bot integration.
//
// MVP scope is tracked in SILI-2671. After the migration / service
...
//
// Architectural boundaries (frozen from Elon's 二审, SILI-2671 §4.8):
//
