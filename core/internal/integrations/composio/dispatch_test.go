...
// --- Overlay follows the agent owner, not the run originator (SILI-3963) ---
...
// TestBuildTaskOverlay_UsesOwnerConnectionNotOriginator is the SILI-3963
...
//   - CreateSession was called with the Silieco user id verbatim
...
func TestBuildTaskOverlay_HappyPath_FiltersBothWays(t *testing.T) {
	...
	// composio_user_id == Silieco user id invariant
	if sdkFake.lastSessReq.UserID != uuidToString(owner) {
