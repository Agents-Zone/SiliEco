...
// (SILI-4257): a daemon:rpc_request is routed to the registered handler with the
...
// TestRPCDispatch_ServerTimeoutCancelsHandler pins the SILI-4257 review fix: the
