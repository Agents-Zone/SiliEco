...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.silieco.ai"
	cookieDomain string // cookie scope, e.g. ".silieco.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.silieco.ai")
//   - COOKIE_DOMAIN           (e.g. ".silieco.ai")
