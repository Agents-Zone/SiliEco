...
// (Silieco Cloud Node) PAT. Tokens with this prefix are validated by
// calling the Silieco Cloud Fleet service rather than by hitting our
...
// sili_/mdt_ caches so the three token kinds can't accidentally share
...
// SILIECO_CLOUD_FLEET_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.silieco.cloud). Trailing slashes are trimmed.
