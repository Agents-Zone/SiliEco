...
func TestCheckOrigin(t *testing.T) {
	...
	cases := []struct {
		...
		{"empty origin allowed", "api.silieco.ai", "", "", "1.2.3.4:5678", true},
		{"same-origin allowed (native client default)", "localhost:8080", "http://localhost:8080", "", "1.2.3.4:5678", true},
		{"same-origin allowed (https)", "api.silieco.ai", "https://api.silieco.ai", "", "1.2.3.4:5678", true},
		{"same-origin allowed (case-insensitive host, RFC 7230)", "API.Silieco.AI", "https://api.silieco.ai", "", "1.2.3.4:5678", true},
		{"whitelisted origin allowed (web cross-origin)", "localhost:8080", "http://localhost:3000", "", "1.2.3.4:5678", true},
		{"whitelisted origin allowed (prod web)", "api.silieco.ai", "https://silieco.ai", "", "1.2.3.4:5678", true},
		{"unknown origin rejected (CSWSH defense)", "api.silieco.ai", "https://evil.com", "", "1.2.3.4:5678", false},
		{"different port rejected", "localhost:8080", "http://localhost:9999", "", "1.2.3.4:5678", false},
		{"X-Forwarded-Host from trusted proxy matches origin", "internal.proxy", "https://silieco.ai", "silieco.ai", "127.0.0.1:5678", true},
		{"X-Forwarded-Host from trusted proxy case-insensitive", "internal.proxy", "https://Silieco.AI", "silieco.ai", "10.0.0.1:5678", true},
		{"X-Forwarded-Host from untrusted source rejected", "internal.proxy", "https://example.com", "example.com", "1.2.3.4:5678", false},
		{"X-Forwarded-Host from trusted proxy but evil origin rejected", "internal.proxy", "https://evil.com", "silieco.ai", "127.0.0.1:5678", false},
		{"X-Forwarded-Host present but origin matches direct Host", "silieco.ai", "https://silieco.ai", "other.host", "1.2.3.4:5678", true},
		{"X-Forwarded-Host spoofed by attacker rejected", "internal.proxy", "https://evil.com", "evil.com", "1.2.3.4:5678", false},
		{"X-Forwarded-Host from trusted CIDR range matches origin", "internal.proxy", "https://silieco.ai", "silieco.ai", "10.5.6.7:5678", true},
		{"X-Forwarded-Host from trusted IPv6 proxy matches origin", "internal.proxy", "https://silieco.ai", "silieco.ai", "[::1]:5678", true},
		{"X-Forwarded-Host comma list uses first (client-facing) value", "internal.proxy", "https://silieco.ai", "silieco.ai, proxy.internal", "127.0.0.1:5678", true},
		{"X-Forwarded-Host comma list ignores trailing values", "internal.proxy", "https://staging.silieco.ai", "proxy.internal, staging.silieco.ai", "127.0.0.1:5678", false},
	}
