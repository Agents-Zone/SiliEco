...
//
// Background (GH #5544, SILI-4302, SILI-4897). Migration 197 installs the
...
// band" — which was true only on Silieco's own cloud, where the backfill
...
// a preMigrationHook mechanism (used for migration 103, SILI-2957) that runs
...
// accountable_user_id MUST equal originator_user_id (SILI-4302 §1/§11).
