...
//
//   - core/cmd/backfill_task_usage_hourly: explicit operator command,
//     used by the SELF-HOST UPGRADE ORDER documented in that file.
//   - core/cmd/migrate: invoked as a hook BEFORE migration 103 runs,
...
//   - cmd/migrate's pre-103 hook (SILI-2957).
...
// time.Now() participates. (SILI-2957 review: blocker #3.)
...
// because of container clock drift. (SILI-2957 review: see张大彪's
// blocker #3.)
