...
func TestCreateSquad_PlainMemberBecomesCreator(t *testing.T) {
	...
	memberID := createPlainMember(t, "squad-creator@silieco.test")
...
func TestManageSquad_CreatorCanManageOwn(t *testing.T) {
	...
	memberID := createPlainMember(t, "squad-owner-manage@silieco.test")
...
func TestManageSquad_StrangerMemberForbidden(t *testing.T) {
	...
	creatorID := createPlainMember(t, "squad-stranger-creator@silieco.test")
	strangerID := createPlainMember(t, "squad-stranger-other@silieco.test")
