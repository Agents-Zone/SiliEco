...
//     SILI-3130 regression this deliberately avoids — and avatars already
...
// absolutizeAvatarPath anchors the served path on SILIECO_PUBLIC_URL when it
