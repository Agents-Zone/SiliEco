...
func (h *Handler) DeleteProject(w http.ResponseWriter, r *http.Request) {
	...
	if err := qtx.ClearProjectWorkflowTasks(r.Context(), db.ClearProjectWorkflowTasksParams{
		ProjectID: project.ID, WorkspaceID: project.WorkspaceID,
	}); err != nil {
		writeError(w, http.StatusInternalServerError, "failed to detach project workflow tasks")
		return
	}
	if err := qtx.DeleteProjectWorkflowGateDecisions(r.Context(), db.DeleteProjectWorkflowGateDecisionsParams{
		ProjectID: project.ID, WorkspaceID: project.WorkspaceID,
	}); err != nil {
	...
	if err := qtx.DeleteProjectWorkflowInstances(r.Context(), db.DeleteProjectWorkflowInstancesParams{
		...
		writeError(w, http.StatusInternalServerError, "failed to delete project workflow runs")
		return
	}
	if err := qtx.DeleteProjectWorkflowStages(r.Context(), db.DeleteProjectWorkflowStagesParams{
		ProjectID: project.ID, WorkspaceID: project.WorkspaceID,
	}); err != nil {
		writeError(w, http.StatusInternalServerError, "failed to delete project workflow stages")
		return
	}
	if err := qtx.DeleteProjectWorkflowVersions(r.Context(), db.DeleteProjectWorkflowVersionsParams{
		ProjectID: project.ID, WorkspaceID: project.WorkspaceID,
	}); err != nil {
		writeError(w, http.StatusInternalServerError, "failed to delete project workflow versions")
		return
	}
	if err := qtx.DeleteProjectWorkflows(r.Context(), db.DeleteProjectWorkflowsParams{
		ProjectID: project.ID, WorkspaceID: project.WorkspaceID,
	}); err != nil {
