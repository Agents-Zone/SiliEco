...
// TestCreateCloudRuntimeNodeForwardsBody is the post-SILI-2671 happy
// path for CreateCloudRuntimeNode: the handler no longer reads, asks
// for, or auto-generates an sili_ PAT — Cloud now mints its own
// node-scoped mcn_ PAT during /api/v1/nodes and ships it to the EC2
// instance via SSM. Silieco-api just forwards the request body and
