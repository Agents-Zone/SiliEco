...
func TestCanonicalBusinessEmail(t *testing.T) {
	cases := []struct {
		...
		{"plain", "ada@silieco.ai", "ada@silieco.ai", true},
		{"uppercase normalized", "Ada@Silieco.AI", "ada@silieco.ai", true},
		{"trim whitespace", "  ada@silieco.ai  ", "ada@silieco.ai", true},
		{"display name stripped", "Ada Lovelace <ada@silieco.ai>", "ada@silieco.ai", true},
		{"angle-bracketed", "<ada@silieco.ai>", "ada@silieco.ai", true},
		{"empty", "", "", false},
		{"only whitespace", "   ", "", false},
		{"missing at", "no-at-sign", "", false},
		{"missing local", "@silieco.ai", "", false},
