...
// TestCreateComment_MixedMentionSurfacesPartialTriggerOutcomes is the SILI-4525 §2
...
// enumeration-safety rule (SILI-4525 §2): a mention the author cannot invoke and a
...
// (SILI-4525). The old first-mention-wins dedup could drop the leader role when
...
// coalesced — never a second task, and never both reported queued (SILI-4525).
