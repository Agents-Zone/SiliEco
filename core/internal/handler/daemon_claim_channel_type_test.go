...
// channel, not just Slack (SILI-4899).
//
...
// mis-flag made the daemon inject `silieco attachment upload` guidance into a
...
// `silieco chat history` and `silieco chat thread`, and both endpoints are
