...
func TestCommentMentionsAnyone(t *testing.T) {
	cases := []struct {
		...
		{name: "issue mention only", content: "see [SILI-1](mention://issue/33333333-3333-3333-3333-333333333333)", want: false},
		{name: "issue + plain text", content: "see [SILI-1](mention://issue/33333333-3333-3333-3333-333333333333) for context", want: false},
		...
		{name: "issue plus member", content: "blocks [SILI-1](mention://issue/33333333-3333-3333-3333-333333333333) — [@Bob](mention://member/22222222-2222-2222-2222-222222222222)", want: true},
	}
...
func TestShouldEnqueueSquadLeaderOnComment_SkipsWhenMemberMentionsAnyone(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			content:     "blocked by [SILI-1](mention://issue/" + testUserID + ")",
			authorType:  "member",
			authorID:    testUserID,
			want:        true,
...
// pins the SILI-3879 restored behavior in the new SILI-3794 cascade: an
...
// TestCreateComment_DualRoleAgentWorkerCommentWakesLeader pins the SILI-3879
...
// pins SILI-4024's direct-mention gap:
//
...
// pins SILI-4024's thread-parent gap: a member reply to the leader's earlier
...
// SILI-2218: auto-retry of a leader-role task must produce a child task that is
