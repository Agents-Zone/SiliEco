...
// Composio integration handlers (SILI-3720, Stage 2 MVP). A Composio connection
...
// (outside the Auth group, see router.go / SILI-3843) because the browser often
...
// Since SILI-4009 the catalog only contains connectable toolkits, so
...
// router.go / SILI-3843), because the browser frequently lands here without a
...
// connectable Composio toolkits for the Settings UI to render. Since SILI-4009
