...
// verifying that a self-host deployment without SILIECO_LARK_SECRET_KEY
...
// TestListActiveLarkInstallations_SkipsOrphans pins the SILI-3515 hub-boot
...
// TestBeginLarkInstall_AuthorizesAgentOwnerAndAdmins is the core of SILI-4213:
...
// and workspace owner/admins may revoke, an unrelated member may not (SILI-4213).
...
// orphan-cleanup path (Elon review on SILI-4213 / PR #5079): when the bound
