...
// request that passed Auth as a JWT or sili_ PAT does NOT carry
...
func TestRequireHumanActor_AllowsHumanRequest(t *testing.T) {
	...
	// No X-Actor-Source — this is the JWT / sili_ PAT shape.
...
//     sili_ PAT) leaves the header empty. So "non-empty AND not
