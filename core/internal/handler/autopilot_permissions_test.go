...
// blocked again after the grant is revoked (SILI-3807).
func TestAutopilotCollaborator_GrantedMemberCanWrite(t *testing.T) {
	...
	member := createPlainMember(t, "ap-collab-grantee@silieco.test")
...
func TestAutopilotCollaborator_NonWriterCannotGrant(t *testing.T) {
	...
	stranger := createPlainMember(t, "ap-collab-stranger@silieco.test")
	victim := createPlainMember(t, "ap-collab-victim@silieco.test")
...
// peers. Only the creator / owner / admin may manage access (SILI-3807).
func TestAutopilotCollaborator_CannotManageAccessList(t *testing.T) {
	...
	carol := createPlainMember(t, "ap-collab-carol@silieco.test")
	dave := createPlainMember(t, "ap-collab-dave@silieco.test")
	bob := createPlainMember(t, "ap-collab-bob2@silieco.test")
...
// delete an autopilot created by someone else (SILI-3807).
func TestAutopilotWrite_PlainMemberCannotMutateOthers(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-stranger@silieco.test")
...
func TestAutopilotWrite_CreatorCanMutateOwn(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-creator@silieco.test")
...
func TestAutopilotWrite_AdminCanMutateMembersAutopilot(t *testing.T) {
	...
	member := createPlainMember(t, "ap-perm-admin-target@silieco.test")
...
// equivalent to being able to trigger the autopilot (SILI-3807).
func TestAutopilotWrite_WebhookSecretRedactedForNonWriter(t *testing.T) {
	...
	stranger := createPlainMember(t, "ap-perm-secret-stranger@silieco.test")
