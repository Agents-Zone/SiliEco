-- Custom Runtime, PR1 (schema only). See SILI-3284 / GitHub issue #3667.
--
...
CREATE TABLE runtime_profile (
    ...
    -- core/pkg/agent/agent.go. A profile may only be based on a backend
    -- Silieco already officially supports and tests.
