...
-- set from SILI-961 (slug review follow-up).
--
...
--
-- Per db-boy's prod audit (SILI-961 thread, 2026-04-22), two slugs in the §3
...
--
-- Decision on SILI-961: force-rename both via this migration (scheme 1), same
-- playbook as SILI-972 for admin/silieco/new/www. Rename targets `home-1`
