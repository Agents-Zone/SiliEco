-- Human Attribution — enforce the one-way invariant at the DB layer (SILI-4302;
-- decided by Bohan + Elon on the SILI-4302 thread). The application collapses
...
-- unbackfilled-lineage rows (Bohan chose the two-phase rollout on the SILI-4302 thread;
