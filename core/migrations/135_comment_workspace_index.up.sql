...
--
-- Context (SILI-4059): The search handler's WHERE clause contains a
...
-- workspace. Confirmed on prd against `silieco-prod`: a search for
...
-- SILI-4059 was that migrations 032 / 033 / 036 hid CREATE INDEX inside
