...
--
-- Why this column exists: Bohan's live-env triage on SILI-2671 showed that
-- in a group chat where two Silieco-installed bots are bound, Lark's
...
-- `union_id` — see the diag-log capture in SILI-2671 review.
--
