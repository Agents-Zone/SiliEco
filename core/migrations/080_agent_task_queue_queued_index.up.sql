-- Partial index that backs the queued-task TTL sweeper added in SILI-1899
-- (sweepExpiredQueuedTasks in cmd/core/runtime_sweeper.go). The sweeper
...
-- full scan once historical terminal rows accumulate (SILI-1899 baseline:
