-- Add a per-installation `region` so one Silieco deployment can serve
...
-- deployment-wide value (the SILIECO_LARK_HTTP_BASE_URL /
-- SILIECO_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
...
-- core/internal/integrations/lark/types.go — keep the two in lockstep.
