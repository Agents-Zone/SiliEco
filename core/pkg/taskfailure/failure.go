...
//
// History: until SILI-1949, core/daemon code wrote one of a small handful
...
// SILI-1949's offline backfill SQL re-classified those rows into 14
...
// ([SILI-2946](https://silieco/issues/SILI-2946)). Subsequent PRs use
...
// classifier in SILI-1949 grows a matching rule and a backfill migration
...
const (
	// Platform / scheduler side: failure attributable to Silieco
	...
	// message. Treated as platform-side because it is a Silieco-imposed
	...
	// configuration (SILI-5370). Retryable, and cheap to retry: every
