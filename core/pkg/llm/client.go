...
type Config struct {
	// APIKey authenticates against the upstream. Maps to SILIECO_LLM_API_KEY.
	APIKey string
	...
	// SILIECO_LLM_BASE_URL.
	BaseURL string
	// DefaultModel is used when a request omits the model. Maps to
	// SILIECO_LLM_DEFAULT_MODEL. When empty, FallbackModel is used.
	DefaultModel string
