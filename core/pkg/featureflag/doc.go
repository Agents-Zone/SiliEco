...
// Wiring:
//
// The standard way to construct the Service inside the silieco server is
// featureflag.NewServiceFromEnv, which reads SILIECO_FEATURE_FLAGS_FILE for
...
//
// See core/pkg/featureflag/service.go for the public Service API and
