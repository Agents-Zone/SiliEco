...
// (SILI-5231). A fixture test is what makes the next upstream event rename loud
// instead of silent.
...
// exists to prevent (SILI-5231 review).
...
// TestCursorExecuteReportsUnhandledTopLevelTypes is the SILI-5434 regression.
//
...
// SILI-5434's diagnostic gap. The result event writes its text into the same
