...
func TestCopilotStaticModelsExposesFullCatalog(t *testing.T) {
	...
	// docs. Regression guard for silieco-ai/silieco#1948 — the
...
// SILI-5239: kimi-code 0.29 dropped the `models` block and advertises the
...
// (SILI-3125) and buildAntigravityArgs wires opts.Model through, so the UI
