...
// contract: a future Codex effort should reach the picker without a Silieco
...
// TestValidateThinkingLevel_CodexEmptyModelFailsClosed pins the SILI-4347
...
// ── Shared injection fixture (Trump's SILI-2339 constraint) ───────────
//
