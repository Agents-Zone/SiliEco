...
RETURNING id, workspace_id, silieco_user_id, installation_id, channel_type, channel_user_id, config, bound_at
`
...
func (q *Queries) DeleteChannelUserBindingsByWorkspaceMember(ctx context.Context, arg DeleteChannelUserBindingsByWorkspaceMemberParams) error {
	_, err := q.db.Exec(ctx, deleteChannelUserBindingsByWorkspaceMember, arg.WorkspaceID, arg.SiliecoUserID)
	return err
}

const findReusableChannelUserBinding = `-- name: FindReusableChannelUserBinding :one
SELECT b.id, b.workspace_id, b.silieco_user_id, b.installation_id, b.channel_type, b.channel_user_id, b.config, b.bound_at FROM channel_user_binding b
...
SELECT id, workspace_id, silieco_user_id, installation_id, channel_type, channel_user_id, config, bound_at FROM channel_user_binding
