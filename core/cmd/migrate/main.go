...
import (
	...
	"github.com/silieco-ai/silieco/core/internal/attributionbackfill"
	"github.com/silieco-ai/silieco/core/internal/logger"
	"github.com/silieco-ai/silieco/core/internal/migrations"
	"github.com/silieco-ai/silieco/core/internal/taskusagebackfill"
)
...
//
// SILI-2957: the v0.3.4 → current direct-upgrade path needs the hourly
...
//
// SILI-4897 / GH #5544: migration 198 VALIDATEs the strict attribution
...
// out-of-band backfill that Silieco's cloud did, so their legacy rows make
...
// backfill recover automatically (GH #5544 / SILI-4897).
...
// migrations against the same database. See GitHub silieco-ai/silieco#3647.
...
// no-op skip. See GitHub silieco-ai/silieco#3647 / SILI-2923.
