...
// SILI-2956 — concurrent migration race test.
//
// PR silieco-ai/silieco#3658 (SILI-2923) added a Postgres advisory lock
...
//     SILI-2923 / #3658) and effectively become a no-op.
//
// The test connects to whatever DATABASE_URL points at (default
// postgres://silieco:silieco@localhost:5432/silieco?sslmode=disable),
// matching the harness pattern already used in
// core/internal/handler/handler_test.go and
// core/internal/metrics/business_sampler_pgsleep_test.go. If
...
// pooled connection (the original SILI-2923 bug), the side-held lock
