...
const (
	integrationTestEmail         = "integration-test@silieco.ai"
...
func TestSendCodeAndVerify(t *testing.T) {
	const email = "integration-sendcode@silieco.ai"
	ctx := context.Background()
...
func TestVerifyCodeNewUserHasNoWorkspace(t *testing.T) {
	const email = "new-integration-verify@silieco.ai"
	ctx := context.Background()
...
// read-newest / unread-older issue must NOT light the switcher dot (SILI-3695).
