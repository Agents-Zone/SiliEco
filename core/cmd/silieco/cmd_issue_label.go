...
// silieco issue label {list|add|remove} — manages the labels attached to a
// specific issue. The label itself is managed via `silieco label ...`.

var issueLabelCmd = &cobra.Command{
	Use:   "label",
	Short: "Manage labels on a task",
}
