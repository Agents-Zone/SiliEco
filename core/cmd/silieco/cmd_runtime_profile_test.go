...
func TestRunRuntimeProfileList(t *testing.T) {
	...
	t.Setenv("SILIECO_WORKSPACE_ID", "ws-123")
...
func TestRunRuntimeProfileSetPathPreservesExistingConfig(t *testing.T) {
	...
	seed := cli.CLIConfig{ServerURL: "https://api.silieco.ai", WorkspaceID: "ws-123", Token: "sili_xyz"}
	...
	if cfg.ServerURL != "https://api.silieco.ai" || cfg.WorkspaceID != "ws-123" || cfg.Token != "sili_xyz" {
