...
func TestEnvPositiveIntOrDefault(t *testing.T) {
	const key = "SILIECO_TEST_ENV_INT"
	cases := []struct {
		name string
		set  bool
		val  string
...
func TestNewDaemonLogRotatorDefaults(t *testing.T) {
	os.Unsetenv("SILIECO_DAEMON_LOG_MAX_SIZE_MB")
	os.Unsetenv("SILIECO_DAEMON_LOG_MAX_BACKUPS")
	os.Unsetenv("SILIECO_DAEMON_LOG_MAX_AGE_DAYS")
...
func TestNewDaemonLogRotatorEnvOverride(t *testing.T) {
	t.Setenv("SILIECO_DAEMON_LOG_MAX_SIZE_MB", "5")
	t.Setenv("SILIECO_DAEMON_LOG_MAX_BACKUPS", "2")
	t.Setenv("SILIECO_DAEMON_LOG_MAX_AGE_DAYS", "7")
...
// stays bounded (the core of SILI-4330). Uses the 1 MB floor lumberjack enforces.
func TestDaemonLogRotatorRotates(t *testing.T) {
	t.Setenv("SILIECO_DAEMON_LOG_MAX_SIZE_MB", "1")
	t.Setenv("SILIECO_DAEMON_LOG_MAX_BACKUPS", "3")
