...
// Tests for `silieco issue metadata list` 404-degradation behavior, plus
...
// endpoint working.
//
// Background: GitHub issue silieco-ai/silieco#3711 — on self-hosted
// backends that pre-date the per-issue metadata route, agent runtime
// bootstrap calls `silieco issue metadata list <issue> --output json`
