...
postgres_db="silieco_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://silieco:silieco@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
SILIECO_DEV_VERIFICATION_CODE=888888
SILIECO_SERVER_URL=ws://localhost:${backend_port}/ws
