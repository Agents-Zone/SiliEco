...
// core/internal/handler/reserved_slugs.json (the single source of truth).
//
...
const jsonPath = resolve(repoRoot, "core/internal/handler/reserved_slugs.json");
...
lines.push("// Do not edit by hand — edit core/internal/handler/reserved_slugs.json");
...
lines.push(" *");
lines.push(" * Single source of truth: `core/internal/handler/reserved_slugs.json`.");
