...
const DB = process.env.DATABASE_URL || "postgres://silieco:silieco@localhost:5432/silieco_silieco_101?sslmode=disable";
...
async function main() {
  ...
  await page.evaluate((t) => localStorage.setItem("silieco_token", t), token);
