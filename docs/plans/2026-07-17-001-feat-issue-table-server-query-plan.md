...
- `core/internal/handler/issue.go::ListIssues`
...
- `core/internal/handler/issue.go::QueryIssues`
  - 只是 `GET /api/issues` 的 POST twin，接收 string map，解决大量 IDs 的 request-line 限制。
- `core/internal/handler/issue.go::ListGroupedIssues`
...
- `core/internal/handler/property.go`
...
新建 `core/internal/handler/issue_query_filter.go`，抽出 canonical filter representation 和 SQL builder：
...
新建 `core/internal/handler/issue_table_group.go`：
...
- **Dependencies:** none。
- **Files:**
  - `core/internal/handler/issue_query_filter.go`（new）
  - `core/internal/handler/issue.go`
  - `core/internal/handler/issue_table_filters_test.go`
  - `core/internal/handler/issue_involves_test.go`
...
- **Dependencies:** U1。
- **Files:**
  - `core/internal/handler/issue_table_group.go`（new）
  - `core/internal/handler/issue_table_query.go`（new）
  - `core/internal/handler/issue_table_query_test.go`（new）
  - `core/cmd/core/router.go`
  - `core/internal/featureflags/keys.go`
...
- **Dependencies:** U1、U2。
- **Files:**
  - `core/internal/handler/issue_table_query.go`
  - `core/internal/handler/issue_table_cursor.go`（new）
  - `core/internal/handler/issue_table_query_test.go`
...
- Backend flat/grouped handlers: `core/internal/handler/issue.go`
- Property filter/sort compiler: `core/internal/handler/property.go`
...
- Backend tests: `core/internal/handler/issue_table_filters_test.go`, `issue_grouped_test.go`, `issue_sort_test.go`, `issue_involves_test.go`
