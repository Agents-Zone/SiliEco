 ...
 * The UI wiring is covered by `chat-input.test.tsx` in @silieco/views; this
...
const DATABASE_URL =
  process.env.DATABASE_URL ?? "postgres://silieco:silieco@localhost:5432/silieco?sslmode=disable";
